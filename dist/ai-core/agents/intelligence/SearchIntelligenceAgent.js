...
class SearchIntelligenceAgent extends BaseAgent_1.BaseAgent {
    ...
    detectIntent(query) {
        ...
        if (lower.includes('doctor') || lower.includes('physician'))
            return 'find_doctor';
        if (lower.includes('lab') || lower.includes('test') || lower.includes('checkup'))
            return 'find_lab';
        if (lower.includes('ambulance'))
            return 'book_ambulance';
        if (lower.includes('insurance'))
            return 'get_insurance';
        if (lower.includes('ayurveda') || lower.includes('homeopathy') || lower.includes('wellness'))
            return 'find_wellness';
        if (lower.includes('caregiver') || lower.includes('home care'))
