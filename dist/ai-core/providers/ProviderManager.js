...
class ProviderManager {
    constructor(budgetManager) {
        ...
        this.fallbackOrder = [
            AgentTypes_1.ProviderType.GROQ,
            AgentTypes_1.ProviderType.OLLAMA,
            AgentTypes_1.ProviderType.GEMINI,
            AgentTypes_1.ProviderType.OPENROUTER
        ];
        // Mock mode flag
        this.mockMode = true;
    ...
    initializeCircuitBreakers() {
        for (const type of this.fallbackOrder) {
            this.circuitBreakers.set(type, new CircuitBreaker_1.CircuitBreaker({
                failureThreshold: 3,
                timeout: 120000,
                resetTimeout: 60000
            }));
