...
test('Symbol.toStringTag', { skip: !hasToStringTag }, function (t) {
    ...
    t.test('null objects', { skip: 'toString' in { __proto__} }, function (st) {
        st.plan(2);

        var dict = { __proto__, a: 1 };
        st.equal(inspect(dict), '[Objectprototype] { a: 1 }', 'null object with Symbol.toStringTag');

        dict[Symbol.toStringTag] = 'Dict';
        st.equal(inspect(dict), '[Dictprototype] { a: 1, [Symbol(Symbol.toStringTag)]: \'Dict\' }', 'null object with Symbol.toStringTag');
    });
