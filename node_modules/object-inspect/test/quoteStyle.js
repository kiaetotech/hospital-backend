...
test('quoteStyle option', function (t) {
    t['throws'](function () { inspect(null, { quoteStyle}); }, 'false is not a valid value');
    t['throws'](function () { inspect(null, { quoteStyle}); }, 'true is not a valid value');
    ...
    t['throws'](function () { inspect(null, { quoteStyle}); }, 'NaN is not a valid value');
    t['throws'](function () { inspect(null, { quoteStyle() {} }); }, 'a function is not a valid value');
