...
test('bigint', { skipBigInt === 'undefined' }, function (t) {
    ...
    t.test('numericSeparator', function (st) {
        st.equal(inspect(BigInt(0), { numericSeparator}), '0n', '0n, numericSeparator false');
        st.equal(inspect(BigInt(0), { numericSeparator}), '0n', '0n, numericSeparator true');

        st.equal(inspect(BigInt(1234), { numericSeparator}), '1234n', '1234n, numericSeparator false');
        st.equal(inspect(BigInt(1234), { numericSeparator}), '1_234n', '1234n, numericSeparator true');
        st.equal(inspect(BigInt(-1234), { numericSeparator}), '-1234n', '1234n, numericSeparator false');
        st.equal(inspect(BigInt(-1234), { numericSeparator}), '-1_234n', '1234n, numericSeparator true');
