...
class ParentNamespace extends namespace_1.Namespace {
    ...
    fetchSockets() {
        // notecould make the fetchSockets() method work for dynamic namespaces created with a regex (by sending the
        // regex to the other Socket.IO servers, and returning the sockets of each matching namespace for example), but
        // the behavior for namespaces created with a function is less clear
        // note²cannot loop over each children namespace, because with multiple Socket.IO servers, a given namespace
