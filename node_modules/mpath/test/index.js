  ...
  describe('set', function() {
    ...
    describe('with `special`', function() {
      ...
      describe('array.path', function() {
        describe('with single non-array value', function() {
          it('works', function(done) {
            ...
            assert.deepEqual([
              ...
              { yep, _doc: { special, yep: 'yes' } }
            ], o.arr);

            mpath.set('arr.yep', false, o, special);
            assert.deepEqual([
              { yep, arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }] },
              { yep, _doc: { special, yep} }
            ], o.arr);
        ...
        describe('with array of values', function() {
          it('that are equal in length', function(done) {
            ...
            assert.deepEqual([
              { yep: 'one', arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }] },
              { yep, _doc: { special, yep: 20 } }
            ], o.arr);

            mpath.set('arr.yep', ['one', 2], o, special);
            assert.deepEqual([
              { yep: 'one', arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }] },
              { yep, _doc: { special, yep: 2 } }
            ], o.arr);
        ...
        describe('with single non-array value', function() {
          it('copies the value to each item in array', function(done) {
            ...
            assert.deepEqual([
              ...
              { yep, _doc: { special, yep: { xtra: 'double good' } } }
            ], o.arr);
      ...
      describe('array.array.$.index.path', function() {
        ...
        it('with array', function(done) {
          ...
          assert.deepEqual([
            { yep: 47, arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }],
              _doc: { yep: [15], arr: [{ a, e: 'a' }, { a: { c: 48, b: [1] }, e: 'b' }, { d: 'yep', e: 35 }] } },
            { yep, _doc: { special, yep: 0 } }
          ], o.arr);
      ...
      describe('array.array.path.index', function() {
        it('with single value', function(done) {
          ...
          assert.deepEqual([
            { yep: 47, arr: [{ a: { b: 47 } }, { a: { c: 48 } }, { d: 'yep' }],
              _doc: { yep: [15], arr: [{ a: [4, 8, 15, 16, 23, 42, 108, Object], e: 'a' }, { a: { c: 48, b: [1], 7}, e: 'b' }, { d: 'yep', e: 35 }] } },
            { yep, _doc: { special, yep: 0 } }
          ], o.arr);
        ...
        it('with array', function(done) {
          ...
          assert.deepEqual([
            ...
            { yep, _doc: { arr: [{ a}, { a}, { a}], special, yep: 0 } }
          ], o.arr);
    ...
    describe('get/set integration', function() {
      ...
      it('works', function(done) {
        ...
        vals[1][1] = 'Rambaldi';
        vals[1][2] = [12, 14];
        vals[2] = [{ changed}, [null, ['changed', 'to', 'array']]];
        ...
        const t = [
          ...
          { o: { array: [{ x: { b: { changed} } }, { x: { b: [null, ['changed', 'to', 'array']] } }] } },
          { o: { array: [{ x}] } },
          { o: { array: [{ y: 3 }] } },
          { o: { array: [3, 0, null] } },
          { o: { name: 'ha' } }
    ...
    it('underneath a map', function(done) {
      ...
      assert.equal(mpath.get('a.b', { aMap([['b', 1]]) }), 1);
