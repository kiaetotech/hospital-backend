 ...
 */
/**
 * A URL matches aboutif its scheme is "about", its path contains a single string
 * "blank", its username and password are the empty string, and its host is null.
 * https://html.spec.whatwg.org/multipage/urls-and-fetching.html#matches-about* @param {string} url
 * @return {boolean}
 */
export function urlMatchesAboutBlank(url) {
    // An empty string is a special case, and considered to be about.
    ...
    try {
        ...
        // Wrong URL considered do not match about.
