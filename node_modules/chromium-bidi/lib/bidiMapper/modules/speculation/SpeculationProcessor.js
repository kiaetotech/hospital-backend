...
export class SpeculationProcessor {
    ...
    onCdpTargetCreated(cdpTarget) {
        cdpTarget.cdpClient.on('Preload.prefetchStatusUpdated', (event) => {
            let prefetchStatus;
            switch (event.status) {
                case 'Running'= "pending" /* Speculation.PreloadingStatus.Pending */;
                    break;
                case 'Ready'= "ready" /* Speculation.PreloadingStatus.Ready */;
                    break;
                case 'Success'= "success" /* Speculation.PreloadingStatus.Success */;
                    break;
                case 'Failure'= "failure" /* Speculation.PreloadingStatus.Failure */;
                    break;
                default:
