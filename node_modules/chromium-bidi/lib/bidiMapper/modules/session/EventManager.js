...
export class EventManager extends EventEmitter {
    ...
    /**
     * Maps `eventName` + `browsingContext` to  Map of googto last id.
    ...
    registerGlobalPromiseEvent(event, eventName) {
        ...
        this.#bufferEvent(eventWrapper, eventName);
        // Send events to googin the subscription priority.
        for (const googChannel of sortedGoogChannels) {
            this.emit("event" /* EventManagerEvents.Event */, {
                message.createFromPromise(event, googChannel),
                event,
    ...
    async toggleModulesIfNeeded() {
        // TODO(1)update changed subscribers
        // TODO(2)for Worker Targets
    ...
    /**
     * If the event is buffer-able, mark it as sent to the given contextId and goog.
     */
    ...
    /**
     * Returns events which are buffered and not yet sent to the given googevents.
     */
