...
export function unrollEvents(events) {
    ...
    for (const event of events) {
        switch (event) {
            case ChromiumBidi.BiDiModule.Bluetooth(Object.values(ChromiumBidi.Bluetooth.EventNames));
                break;
            case ChromiumBidi.BiDiModule.BrowsingContext(Object.values(ChromiumBidi.BrowsingContext.EventNames));
                break;
            case ChromiumBidi.BiDiModule.Input(Object.values(ChromiumBidi.Input.EventNames));
                break;
            case ChromiumBidi.BiDiModule.Log(Object.values(ChromiumBidi.Log.EventNames));
                break;
            case ChromiumBidi.BiDiModule.Network(Object.values(ChromiumBidi.Network.EventNames));
                break;
            case ChromiumBidi.BiDiModule.Script(Object.values(ChromiumBidi.Script.EventNames));
                break;
            case ChromiumBidi.BiDiModule.Speculation(Object.values(ChromiumBidi.Speculation.EventNames));
                break;
            default.add(event);
        }
    }
...
export class SubscriptionManager {
    ...
    #isSubscribedTo(subscription, moduleOrEvent, browsingContextId) {
        ...
        for (const eventName of subscription.eventNames) {
            // This also covers the `goog` case where
    ...
    /**
     * Subscribes to event in the given context and goog.
