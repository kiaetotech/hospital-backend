...
export class InputState {
    ...
    getOrCreate(id, type, subtype) {
        ...
        if (!source) {
            switch (type) {
                case "none" /* SourceType.None */= new NoneSource();
                    break;
                case "key" /* SourceType.Key */= new KeySource();
                    break;
                ...
                case "wheel" /* SourceType.Wheel */= new WheelSource();
                    break;
                defaultnew InvalidArgumentException(`Expected "${"none" /* SourceType.None */}", "${"key" /* SourceType.Key */}", "${"pointer" /* SourceType.Pointer */}", or "${"wheel" /* SourceType.Wheel */}". Found unknown source type ${type}.`);
            }
