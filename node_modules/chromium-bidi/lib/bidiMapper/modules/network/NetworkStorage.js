...
// https://source.chromium.org/chromium/chromium/src/+/main_party/blink/renderer/core/inspector/inspector_network_agent.cc;drc=da1f749634c9a401cc756f36c2e6ce233e1c9b4d;l=133
...
export class NetworkStorage {
    ...
    async getCollectedData(params) {
        ...
        switch (params.dataType) {
            case "response" /* Network.DataType.Response */= await this.#getCollectedResponseData(request);
                break;
            case "request" /* Network.DataType.Request */= await this.#getCollectedRequestData(request);
                break;
    ...
    async #getCollectedRequestData(request) {
        // TODOCDP error in case of the renderer is gone.
    ...
    disposeRequest(id) {
        ...
        // TODONetwork data from Chromium once there is a CDP command for that.
