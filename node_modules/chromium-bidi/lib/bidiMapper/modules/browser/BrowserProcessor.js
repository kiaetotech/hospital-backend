...
export class BrowserProcessor {
    ...
    async createUserContext(params) {
        ...
        // parameter is specified, we should get rid of `goog` and
        // `goog` and make the params of type
        ...
        if (w3cParams.acceptInsecureCerts !== undefined) {
            if (w3cParams.acceptInsecureCerts === false &&
                ...
                // TODO://github.com/GoogleChromeLabs/chromium-bidi/issues/3398
        ...
        if (w3cParams.proxy) {
            ...
            // TODOafter Puppeteer stops using it.
    ...
    async removeUserContext(params) {
        ...
        try {
            ...
            // https://source.chromium.org/chromium/chromium/src/+/main/browser/devtools/protocol/target_handler.cc;l=1424;drc=c686e8f4fd379312469fe018f5c390e9c8f20d0d
 ...
 * https://source.chromium.org/chromium/chromium/src/+/main/proxy_resolution/proxy_config.h;drc=743a82d08e59d803c94ee1b8564b8b11dd7b462f;l=107
 */
