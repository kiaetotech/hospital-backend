...
export class BrowsingContextProcessor {
    ...
    async create(params) {
        ...
        let newWindow = false;
        switch (params.type) {
            case "tab" /* BrowsingContext.CreateType.Tab */= false;
                break;
            case "window" /* BrowsingContext.CreateType.Window */= true;
                break;
        }
        ...
        try {
            ...
            if (
            // See https://source.chromium.org/chromium/chromium/src/+/main/browser/devtools/protocol/target_handler.cc;l=90;drc=e80392ac11e48a691f4309964cab83a3a59e01c8
            err.message.startsWith('Failed to find browser context with id') ||
                // See https://source.chromium.org/chromium/chromium/src/+/main/lib/browser/protocol/target_handler.cc;l=49;drc=e80392ac11e48a691f4309964cab83a3a59e01c8
        ...
        // `browsingContext.load` events from the initial `about` navigation
        // are emitted after the next navigation is started.
        // Details://github.com/web-platform-tests/wpt/issues/35846
    ...
    async handleUserPrompt(params) {
        ...
        try {
            ...
            // https://source.chromium.org/chromium/chromium/src/+/main/browser/devtools/protocol/page_handler.cc;l=1085?q=%22No%20dialog%20is%20showing%22&ss=chromium
