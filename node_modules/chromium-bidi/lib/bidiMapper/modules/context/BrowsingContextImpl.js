...
export class BrowsingContextImpl {
    ...
    static create(id, parentId, userContext, cdpTarget, eventManager, browsingContextStorage, realmStorage, configStorage, url, originalOpener, logger) {
        ...
        eventManager.registerPromiseEvent(context.targetUnblockedOrThrow().then(() => {
            return {
                ...
                value: {
                    type: 'event',
                    method.BrowsingContext.EventNames.ContextCreated,
                    params: {
                        ...
                        // TODOonce https://crbug.com/372842894 is addressed.
                        url,
                    },
                },
            };
    ...
    dispose(emitContextDestroyed) {
        ...
        if (emitContextDestroyed) {
            this.#eventManager.registerEvent({
                type: 'event',
                method.BrowsingContext.EventNames.ContextDestroyed,
    ...
    #initListeners() {
        this.#cdpTarget.cdpClient.on('Network.loadingFailed', (params) => {
            // Detect navigation errors like `net:_BLOCKED_BY_RESPONSE`.
        ...
        this.#cdpTarget.cdpClient.on('Page.lifecycleEvent', (params) => {
            ...
            switch (params.name) {
                case 'DOMContentLoaded'(!this.#navigationTracker.isInitialNavigation) {
                        ...
                        this.#eventManager.registerEvent({
                            type: 'event',
                            method.BrowsingContext.EventNames.DomContentLoaded,
                            params: {
                                context.id,
                ...
                case 'load'(!this.#navigationTracker.isInitialNavigation) {
                        ...
                        this.#eventManager.registerEvent({
                            type: 'event',
                            method.BrowsingContext.EventNames.Load,
                            params: {
                                context.id,
                                navigation.#navigationTracker.currentNavigationId,
                                timestamp(),
        ...
        this.#cdpTarget.cdpClient.on('Runtime.executionContextCreated', (params) => {
            ...
            if (auxData.isDefault) {
                ...
                // TODOfor not default realms by the sandbox name.
        ...
        this.#cdpTarget.cdpClient.on('Page.javascriptDialogClosed', (params) => {
            ...
            // versions that do not have a frameId. TODOonce
            ...
            if (!params.frameId &&
                ...
                // CDP target. TODOonce https://crrev.com/c/6487891 is in stable.
                return;
            }
        ...
        this.#cdpTarget.cdpClient.on('Page.javascriptDialogOpening', (params) => {
            ...
            switch (promptHandler) {
                ...
                case "accept" /* Session.UserPromptHandlerType.Accept */this.handleUserPrompt(true);
                    break;
                case "dismiss" /* Session.UserPromptHandlerType.Dismiss */this.handleUserPrompt(false);
                    break;
        ...
        this.#cdpTarget.browserCdpClient.on('Browser.downloadWillBegin', (params) => {
            ...
            this.#eventManager.registerEvent({
                type: 'event',
                method.BrowsingContext.EventNames.DownloadWillBegin,
                params: {
                    context.id,
        ...
        this.#cdpTarget.browserCdpClient.on('Browser.downloadProgress', (params) => {
            ...
            switch (params.state) {
                case 'canceled'.#eventManager.registerEvent({
                        type: 'event',
                        method.BrowsingContext.EventNames.DownloadEnd,
                        params: {
                            status: 'canceled',
                            context.id,
                            navigation.guid,
    ...
    static #getPromptType(cdpType) {
        switch (cdpType) {
            case 'alert'"alert" /* BrowsingContext.UserPromptType.Alert */;
            case 'beforeunload'"beforeunload" /* BrowsingContext.UserPromptType.Beforeunload */;
            case 'confirm'"confirm" /* BrowsingContext.UserPromptType.Confirm */;
            case 'prompt'"prompt" /* BrowsingContext.UserPromptType.Prompt */;
        }
    }
    /**
    ...
    #getPromptHandler(promptType) {
        ...
        switch (promptType) {
            case "alert" /* BrowsingContext.UserPromptType.Alert */(contextConfig.userPromptHandler?.alert ??
                    contextConfig.userPromptHandler?.default ??
                    defaultPromptHandler);
            case "beforeunload" /* BrowsingContext.UserPromptType.Beforeunload */(contextConfig.userPromptHandler?.beforeUnload ??
                    contextConfig.userPromptHandler?.default ??
                    "accept" /* Session.UserPromptHandlerType.Accept */);
            case "confirm" /* BrowsingContext.UserPromptType.Confirm */(contextConfig.userPromptHandler?.confirm ??
                    contextConfig.userPromptHandler?.default ??
                    defaultPromptHandler);
            case "prompt" /* BrowsingContext.UserPromptType.Prompt */(contextConfig.userPromptHandler?.prompt ??
                    contextConfig.userPromptHandler?.default ??
                    defaultPromptHandler);
        }
    }
    ...
    async navigate(url, wait) {
        ...
        if (result instanceof NavigationResult) {
            if (
            // TODOafter decision on the spec is done:
    ...
    // TODOconcurrent navigations analogous to `navigate`.
    ...
    /**
     * See
     * https://w3c.github.io/webdriver-bidi/#:~=If%20command%20parameters%20contains%20%22clip%22%3A
     */
    ...
    async locateNodes(params) {
        // TODOa dedicated sandbox instead of `#defaultRealm`.
            ...
            case 'css'{
                    functionDeclaration((cssSelector, maxNodeCount, ...startNodes) => {
                        ...
                        const returnedNodes = startNodes
                            .map((startNode) => 
                        // TODOsearch early if `maxNodeCount` is reached.
    ...
    async #locateNodesByContextLocator(locator, startNodes, realm, serializationOptions) {
        ...
        try {
            ...
            const locatorResult = await realm.callFunction(`function () { return this; }`, false, { handle.objectId }, [], "none" /* Script.ResultOwnership.None */, serializationOptions);
