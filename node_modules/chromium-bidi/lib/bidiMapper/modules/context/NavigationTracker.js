...
export class NavigationState {
    ...
    start() {
        ...
        !this.#isInitial &&
            ...
            // https://html.spec.whatwg.org/#beginning-navigation-bidi-navigation-started
    ...
    frameNavigated() {
        ...
        if (!this.#isInitial) {
            this.#eventManager.registerEvent({
                type: 'event',
                method.BrowsingContext.EventNames.NavigationCommitted,
                params.navigationInfo(),
            }, this.#browsingContextId);
        }
    }
...
/**
 * Keeps track of navigations. Details://go/webdriver-navigation
 */
export class NavigationTracker {
     ...
     */
    #pendingNavigation;
    // Flags if the initial navigation to `about` is in progress.
    ...
    /**
     * Flags if the current navigation relates to the initial to `about` navigation.
     */
    ...
    #getNavigationForFrameNavigated(url, loaderId) {
        ...
        if (this.#pendingNavigation !== undefined &&
            ...
            // This can be a pending navigation to `about` created by a command. Use the
    ...
    navigatedWithinDocument(url, navigationType) {
        ...
        if (navigationType !== 'fragment') {
            // TODOfor other navigation types, like `javascript`.
            return;
        }
     ...
     * TODOshould be complete when it became the current one on
