...
JavaScriptCompiler.prototype = {
  ...
  mergeSource(varDeclarations) {
    ...
    if (appendOnly) {
      ...
      varDeclarations +=
        ', buffer = ' + (appendFirst ? '' .initializeBuffer());
  ...
  // On stack, after, if lastHelperambiguousBlockValue() {
  ...
  resolvePath(type, parts, startPartIndex, falsy, strict) {
  ...
  topStack() {
    let stack = this.isInline() ? this.inlineStack .compileStack,
