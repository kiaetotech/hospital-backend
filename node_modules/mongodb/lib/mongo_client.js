 ...
 * const client = new MongoClient('mongodb://localhost:27017', { monitorCommands});
 *
...
class MongoClient extends mongo_types_1.TypedEventEmitter {
    constructor(url, options) {
        ...
        this.s = {
            ...
            hasBeenClosed,
            sessionPoolsessions_1.ServerSessionPool(this),
            activeSessionsSet(),
            get options() {
    ...
    async close(force = false) {
        ...
        if (servers.length !== 0) {
            ...
            if (endSessions.length !== 0) {
                await this.db('admin')
                    .command({ endSessions }, { readPreference_preference_1.ReadPreference.primaryPreferred, noResponse})
    ...
    startSession(options) {
        const session = new sessions_1.ClientSession(this, this.s.sessionPool, { explicit, ...options }, this[kOptions]);
    ...
    async withSession(optionsOrOperation, callback) {
        ...
        const withSessionCallback = typeof optionsOrOperation === 'function' ? optionsOrOperation ;
