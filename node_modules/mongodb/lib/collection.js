...
class Collection {
    ...
    constructor(db, name, options) {
        ...
        this.s = {
            db,
            options,
            namespaceutils_1.MongoDBCollectionNamespace(db.databaseName, name),
            pkFactory.options?.pkFactory ?? utils_1.DEFAULT_PK_FACTORY,
            readPreference_preference_1.ReadPreference.fromOptions(options),
            bsonOptions: (0, bson_1.resolveBSONOptions)(options, db),
            readConcern_concern_1.ReadConcern.fromOptions(options),
            writeConcern_concern_1.WriteConcern.fromOptions(options)
        };
    ...
    async insertMany(docs, options) {
        return (0, execute_operation_1.executeOperation)(this.client, new insert_1.InsertManyOperation(this, docs, (0, utils_1.resolveOptions)(this, options ?? { ordered})));
    }
    /**
    ...
    async bulkWrite(operations, options) {
        ...
        return (0, execute_operation_1.executeOperation)(this.client, new bulk_write_1.BulkWriteOperation(this, operations, (0, utils_1.resolveOptions)(this, options ?? { ordered})));
    }
    /**
    ...
    async rename(newName, options) {
        ...
        return (0, execute_operation_1.executeOperation)(this.client, new rename_1.RenameOperation(this, newName, {
            ...options,
            readPreference_preference_1.ReadPreference.PRIMARY
        }));
    }
    /**
     ...
     * error.
     *
     * **Note**{@link Collection#createIndex| createIndex}, this function takes in raw index specifications.
    ...
    async createIndexes(indexSpecs, options) {
        return (0, execute_operation_1.executeOperation)(this.client, new indexes_1.CreateIndexesOperation(this, this.collectionName, indexSpecs, (0, utils_1.resolveOptions)(this, { ...options, maxTimeMS})));
    }
    /**
     ...
     * recommended to upgrade their server version to 5.0.9+ or set apiStrictto avoid
     * encountering errors.
     *
     * @see {@link https://www.mongodb.com/docs/manual/reference/command/count/#behavior|Count}
     * @param options - Optional settings for the command
     */
     ...
     * **Note**migrating from {@link Collection#count| count} to {@link Collection#countDocuments| countDocuments}
     ...
     *
     * [1]://www.mongodb.com/docs/manual/reference/operator/query/expr/
     * [2]://www.mongodb.com/docs/manual/reference/operator/query/geoWithin/
     * [3]://www.mongodb.com/docs/manual/reference/operator/query/center/#op._S_center
     * [4]://www.mongodb.com/docs/manual/reference/operator/query/centerSphere/#op._S_centerSphere
     *
     ...
     * @example
     * By just providing the first argument I can type the change to be `ChangeStreamDocument<{ _id}>`
     * ```ts
     * collection.watch<{ _id}>()
     ...
     * ```ts
     * collection
     *   .watch<Schema, ChangeStreamInsertDocument<Schema> & { comment}>([
    ...
    listSearchIndexes(indexNameOrOptions, options) {
        options =
            typeof indexNameOrOptions === 'object' ? indexNameOrOptions == null ? {} ;
        const indexName = indexNameOrOptions == null
            ? null
            indexNameOrOptions === 'object'
                ? null
                ;
