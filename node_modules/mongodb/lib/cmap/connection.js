...
class Connection extends mongo_types_1.TypedEventEmitter {
    constructor(stream, options) {
        ...
        this[kMessageStream] = new message_stream_1.MessageStream({
            ...options,
            maxBsonMessageSize.hello?.maxBsonMessageSize
        });
        this[kStream] = stream;
    ...
    set hello(response) {
        ...
        // TODOthis, and only use the `StreamDescription` in the future
    ...
    onMessage(message) {
        ...
        // SERVER-45775exhaust responses we should be able to use the same requestId to
    ...
    command(ns, command, options, callback) {
        ...
        const message = shouldUseOpMsg
            ...
            commands_1.Query(cmdNs, cmd, commandOptions);
        try {
...
class CryptoConnection extends Connection {
    ...
    command(ns, cmd, options, callback) {
        ...
        const sort = cmd.find || cmd.findAndModify ? cmd.sort ;
...
function write(conn, command, options, callback) {
    ...
    const operationDescription = {
        ...
        cb,
        session.session,
        noResponseoptions.noResponse === 'boolean' ? options.noResponse ,
        documentsReturnedIn.documentsReturnedIn,
        // for BSON parsing
        useBigInt64options.useBigInt64 === 'boolean' ? options.useBigInt64 ,
        promoteLongsoptions.promoteLongs === 'boolean' ? options.promoteLongs ,
        promoteValuesoptions.promoteValues === 'boolean' ? options.promoteValues ,
        promoteBuffersoptions.promoteBuffers === 'boolean' ? options.promoteBuffers ,
        bsonRegExpoptions.bsonRegExp === 'boolean' ? options.bsonRegExp ,
        enableUtf8Validationoptions.enableUtf8Validation === 'boolean' ? options.enableUtf8Validation ,
        rawoptions.raw === 'boolean' ? options.raw ,
        started: 0
    };
    ...
    if (conn.monitorCommands) {
        ...
        operationDescription.cb = (err, reply) => {
            ...
            if (typeof callback === 'function') {
                ...
                // succeeded.
                callback(err, err instanceof error_1.MongoWriteConcernError ? undefined );
            }
        };
    }
