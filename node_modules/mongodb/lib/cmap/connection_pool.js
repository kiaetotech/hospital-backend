...
class ConnectionPool extends mongo_types_1.TypedEventEmitter {
    constructor(server, options) {
        ...
        this.options = Object.freeze({
            ...
            maxConnecting.maxConnecting ?? 2,
            maxIdleTimeMS.maxIdleTimeMS ?? 0,
            waitQueueTimeoutMS.waitQueueTimeoutMS ?? 0,
            minPoolSizeCheckFrequencyMS.minPoolSizeCheckFrequencyMS ?? 100,
     ...
     *
     * TODO(NODE-3263)can remove this property once shell no longer needs it
     */
    get closed() {
    ...
    checkIn(connection) {
        ...
        if (willDestroy) {
            const reason = connection.closed ? 'error' ? 'poolClosed' : 'stale';
    ...
    close(_options, _cb) {
        ...
        options = Object.assign({ force}, options);
        if (this.closed) {
            return callback();
        }
     ...
     *
     * NOTEnote the required signature of `fn`
     *
    ...
    destroyConnection(connection, reason) {
        ...
        process.nextTick(() => connection.destroy({ force}));
    }
    ...
    destroyConnectionIfPerished(connection) {
        ...
        const reason = connection.closed ? 'error' ? 'stale' : 'idle';
        this.destroyConnection(connection, reason);
        return true;
    }
    createConnection(callback) {
        const connectOptions = {
            ...this.options,
            id[kConnectionCounter].next().value,
            generation[kGeneration],
            cancellationToken[kCancellationToken]
        };
        this[kPending]++;
        // This is our version of a "virtual" no-I/O connection as the spec requires
        this.emitAndLog(ConnectionPool.CONNECTION_CREATED, new connection_pool_events_1.ConnectionCreatedEvent(this, { id.id }));
        (0, connect_1.connect)(connectOptions, (err, connection) => {
            if (err || !connection) {
                this[kPending]--;
                this.emitAndLog(ConnectionPool.CONNECTION_CLOSED, new connection_pool_events_1.ConnectionClosedEvent(this, { id.id, serviceId}, 'error', 
                // TODO(NODE-5192)this cast
                err));
            ...
            if (this[kPoolState] !== exports.PoolState.ready) {
                ...
                callback(this.closed ? new errors_1.PoolClosedError(this) errors_1.PoolClearedError(this));
                return;
            }
    ...
    ensureMinPoolSize() {
        ...
        if (this.totalConnectionCount < minPoolSize &&
            ...
            // NOTEshould not try to get all the pending
    ...
    processWaitQueue() {
        ...
        while (this.waitQueueSize) {
            ...
            if (this[kPoolState] !== exports.PoolState.ready) {
                ...
                const error = this.closed ? new errors_1.PoolClosedError(this) errors_1.PoolClearedError(this);
