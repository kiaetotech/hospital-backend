    ...
    if (hello) {
        ...
        if (Array.isArray(hello.saslSupportedMechs)) {
            return hello.saslSupportedMechs.includes(providers_1.AuthMechanism.MONGODB_SCRAM_SHA256)
                ...
                _1.AuthMechanism.MONGODB_SCRAM_SHA1;
        }
...
class MongoCredentials {
    ...
    validate() {
        ...
        if (providers_1.AUTH_MECHS_AUTH_SRC_EXTERNAL.has(this.mechanism)) {
            if (this.source != null && this.source !== '$external') {
                // TODO(NODE-3485)this with a MongoAuthValidationError
    ...
    static merge(creds, options) {
        return new MongoCredentials({
            ...
            mechanism.mechanism ?? creds?.mechanism ?? providers_1.AuthMechanism.MONGODB_DEFAULT,
            mechanismProperties.mechanismProperties ?? creds?.mechanismProperties ?? {},
            source.source ?? options.db ?? creds?.source ?? 'admin'
        });
    }
}
