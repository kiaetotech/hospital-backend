...
class ChangeStream extends mongo_types_1.TypedEventEmitter {
     ...
     *
     * NOTEusing a Stream to process change stream events, the stream will
    ...
    _setIsEmitter() {
        if (this[kMode] === 'iterator') {
            // TODO(NODE-3485)with MongoChangeStreamModeError
    ...
    _createChangeStreamCursor(options) {
        ...
        const pipeline = [{ $changeStream}, ...this.pipeline];
        const client = this.type === CHANGE_DOMAIN_TYPES.CLUSTER
            ? this.parent
            .type === CHANGE_DOMAIN_TYPES.DATABASE
                ? this.parent.client
                .type === CHANGE_DOMAIN_TYPES.COLLECTION
                    ? this.parent.client
                    ;
        if (client == null) {
    ...
    _processChange(change) {
        if (this[kClosed]) {
            // TODO(NODE-3485)with MongoChangeStreamClosedError
