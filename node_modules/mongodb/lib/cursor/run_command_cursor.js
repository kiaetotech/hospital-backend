...
class RunCommandCursor extends abstract_cursor_1.AbstractCursor {
    ...
    /** Unsupported for RunCommandCursormust be configured directly on command document */
    withReadConcern(_) {
        throw new error_1.MongoAPIError('RunCommandCursor does not support readConcern it must be attached to the command being run');
    }
    /** Unsupported for RunCommandCursorcursor flags must be configured directly on command document */
    addCursorFlag(_, __) {
