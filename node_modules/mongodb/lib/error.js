...
// see://github.com/mongodb/specifications/blob/master/source/retryable-writes/retryable-writes.rst#terms
...
function isRetryableReadError(error) {
    const hasRetryableErrorCode = typeof error.code === 'number' ? RETRYABLE_READ_ERROR_CODES.has(error.code) ;
...
function isSDAMUnrecoverableError(error) {
    // NOTEcheck is here for a strictly pre-CMAP world, a timeout or
...
function isResumableError(error, wireVersion) {
    ...
    if (wireVersion != null && wireVersion >= 9) {
        // DRIVERS-13084.4 drivers running against 4.4 servers, drivers will add a special case to treat the CursorNotFound error code as resumable
