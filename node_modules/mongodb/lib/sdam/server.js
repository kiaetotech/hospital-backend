...
class Server extends mongo_types_1.TypedEventEmitter {
    ...
    constructor(topology, description, options) {
        ...
        const poolOptions = { hostAddress.hostAddress, ...options };
        ...
        // create the monitor
        // TODO(NODE-4144)new variable for type narrowing
        ...
        this.monitor.on(Server.SERVER_HEARTBEAT_SUCCEEDED, (event) => {
            this.emit(Server.DESCRIPTION_RECEIVED, new server_description_1.ServerDescription(this.description.hostAddress, event.reply, {
                roundTripTime(this.description.roundTripTime, event.duration)
            }));
    ...
    command(ns, cmd, options, callback) {
        ...
        // Clone the options
        const finalOptions = Object.assign({}, options, { wireProtocolCommand});
        ...
        // NOTEis a hack! We can't retrieve the connections used for executing an operation
    ...
    handleError(error, connection) {
        ...
        if (isNetworkNonTimeoutError || isNetworkTimeoutBeforeHandshakeError || isAuthHandshakeError) {
            ...
            if (!this.loadBalanced) {
                ...
                this.pool.clear({ serviceId.serviceId });
            }
        }
        else {
