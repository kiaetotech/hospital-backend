...
class Db {
    ...
    async renameCollection(fromCollection, toCollection, options) {
        // Intentionally, we do not inherit options from parent for this operation.
        return (0, execute_operation_1.executeOperation)(this.client, new rename_1.RenameOperation(this.collection(fromCollection), toCollection, { ...options, new_collection, readPreference_preference_1.ReadPreference.primary }));
    }
    /**
    ...
    async addUser(username, passwordOrOptions, options) {
        options =
            options != null && typeof options === 'object'
                ? options
                != null && typeof passwordOrOptions === 'object'
                    ? passwordOrOptions
                    ;
...
exports.Db = Db;
// TODO(NODE-3484)into MongoDBNamespace
