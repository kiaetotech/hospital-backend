...
class CommandOperation extends operation_1.AbstractCallbackOperation {
    constructor(parent, options) {
        ...
        // NOTEwas explicitly added for the add/remove user operations, it's likely
        ...
        if (dbNameOverride) {
            ...
            this.ns = parent
                ...
                utils_1.MongoDBNamespace('admin', '$cmd');
        }
    ...
    async executeCommand(server, session, cmd) {
        // TODOmaking this a non-enumerable property
        this.server = server;
        const options = {
            ...this.options,
            ...this.bsonOptions,
        ...
        if (this.readConcern && (0, utils_1.commandSupportsReadConcern)(cmd) && !inTransaction) {
            Object.assign(cmd, { readConcern.readConcern });
        }
        ...
        if (options.collation &&
            ...
            Object.assign(cmd, { collation.collation });
        }
