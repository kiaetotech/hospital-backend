...
function exists(commandName, options) {
    commandName = (options === null || options === void 0 ? void 0 .caseInsensitive)
 ...
 *
 * Some of possible flags, noscript, loading
 */
function hasFlag(commandName, flag, options) {
    commandName = (options === null || options === void 0 ? void 0 .nameCaseInsensitive)
        ? String(commandName).toLowerCase()
        ;
...
function getKeyIndexes(commandName, args, options) {
    ...
    switch (commandName) {
        case "zunionstore""zinterstore""zdiffstore".push(0, ...takeDynamicKeys(args, 1));
            break;
        case "eval""evalsha""eval_ro""evalsha_ro""fcall""fcall_ro""blmpop""bzmpop".push(...takeDynamicKeys(args, 1));
            break;
        case "sintercard""lmpop""zunion""zinter""zmpop""zintercard""zdiff": {
