    ...
    send(packets) {
        ...
        for (let i = 0; i < packets.length; i++) {
            ...
            if (this._canSendPreEncodedFrame(packet)) {
                ...
                this.socket._sender.sendFrame(packet.options.wsPreEncodedFrame, isLast ? this._onSentLast ._onSent);
            }
            else {
                this.parser.encodePacket(packet, this.supportsBinary, isLast ? this._doSendLast ._doSend);
            }
        }
    }
    /**
