...
class uServer extends server_1.BaseServer {
    ...
    prepare(req, res) {
        ...
        // @ts-expect-error
        req.connection = {
            remoteAddress.from(res.getRemoteAddressAsText()).toString(),
        };
        res.onAborted(() => {
    ...
    attach(app /* */, options = {}) {
        ...
        app
            ...
            upgrade.handleUpgrade.bind(this),
            open: (ws) => {
            ...
            message: (ws, message, isBinary) => {
                ws.getUserData().transport.onData(isBinary ? message .from(message).toString());
            },
        ...
        const callback = (errorCode, errorContext) => {
            if (errorCode !== undefined) {
                this.emit("connection_error", {
                    req,
                    code,
                    message_1.Server.errorMessages[errorCode],
                    context,
                });
    ...
    abortRequest(res, errorCode, errorContext) {
        ...
        const message = errorContext && errorContext.message
            ...
            _1.Server.errorMessages[errorCode];
...
class ResponseWrapper {
    ...
    // needed by vary://github.com/jshttp/vary/blob/5d725d059b3871025cf753e9dfa08924d0bcfa8f/index.js#L134
    getHeader() { }
    writeStatus(status) {
        if (this.isAborted)
            return;
