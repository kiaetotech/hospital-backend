...
test('Symbol.toStringTag does not exist', { skip() }, function (t) {
	t.equal(typeof Symbol === 'undefined' ? 'undefined' Symbol.toStringTag, 'undefined', 'global Symbol.toStringTag is undefined');
	t.end();
});
