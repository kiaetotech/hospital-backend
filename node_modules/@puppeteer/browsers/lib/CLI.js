...
export class CLI {
    ...
    #defineBrowserParameter(yargs, required) {
        return yargs.positional('browser', {
            ...
            coerce: (opt) => {
                const browser = {
                    name.#parseBrowser(opt),
                    buildId.#parseBuildId(opt),
                };
    ...
    #definePlatformParameter(yargs) {
        return yargs.option('platform', {
            ...
            choices.values(BrowserPlatform),
            default(),
            coerce=> {
    ...
    #definePathParameter(yargs, required = false) {
        ...
        return yargs.option('path', {
            ...
            ...(required ? {} : { default.cwd() }),
            demandOption,
        });
    }
    async run(argv) {
        const { default} = await import('yargs');
        ...
        return yargs
            ...
            const executablePath = args.system
                ? computeSystemExecutablePath({
                    ...
                    // TODOan error if not a ChromeReleaseChannel is provided.
                    channel.browser.buildId,
                    platform.platform,
                })
                ({
                    browser.browser.name,
                    buildId.browser.buildId,
                    cacheDir.path ?? this.#cachePath,
                    platform.platform,
                });
            launch({
                args,
    ...
    async #install(args) {
        ...
        await install({
            ...
            baseUrl.baseUrl,
            buildIdAlias!== args.browser.buildId ? originalBuildId ,
