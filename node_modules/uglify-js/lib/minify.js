...
function read_source_map(name, toplevel) {
    ...
    for (var i = comments.length; --i >= 0;) {
        ...
        if (match[1] == "sourceMappingURL") {
            match = /^data\/json(;.*?)?;base64,([^,]+)$/.exec(match[2]);
            if (!match) break;
...
function minify(files, options) {
    try {
        options = defaults(options, {
            ...
            sourceMap,
            timings,
            toplevel&& !options["expression"] && options["module"] ? true ,
            v8,
            validate,
            warnings,
            webkit,
        ...
        var timings = options.timings && { start.now() };
        ...
        if (options.mangle) {
            options.mangle = defaults(options.mangle, {
                cache.nameCache && (options.nameCache.vars || {}),
                eval,
                ie,
                keep_fargs,
                keep_fnames,
        ...
        if (output.code) {
            ...
            if (options.sourceMap) {
                ...
                if (url) {
                    ...
                    if (url == "inline") {
                        result.code += "\n//# sourceMappingURL=data/json;charset=utf-8;base64," + to_base64(result.map);
                    } else {
