...
let experimentalSpeciferResolution = tsNodeExperimentalSpecifierResolution != null ? tsNodeExperimentalSpecifierResolution ('--experimental-specifier-resolution');
...
function defaultGetFormat(url, context, defaultGetFormatUnused) {
  ...
  if (parsed.protocol === 'data:') {
    ...
    const format = ({
      ...
      'application/wasm'? 'wasm' })[mime] || null;
    return { format };
