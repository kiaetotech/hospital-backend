      ...
      function registerVariableDeclarationIdentifiers(node) {
        switch (node.type) {
          case 'Identifier'(
            ...
            break;
          case 'ObjectPattern'(node.properties, (property) => {
              registerVariableDeclarationIdentifiers(property.value);
            });
            break;
          case 'ArrayPattern'(node.elements, (element) => {
...
function processTopLevelAwait(src) {
  ...
  try {
    ...
    const column = line === 1 ? e.loc.column - wrapPrefix.length .loc.column;
  ...
  // Do not transform if
  // 1. False alarmisn't actually an await expression.
