 ...
 *
 * NOTEfactory returns *only* functions which need a reference to the TS
...
function createTsInternalsUncached(_ts) {
    ...
    function getExtendsConfigPath(extendedConfig, host, basePath, errors, createDiagnostic) {
        ...
        const resolved = ts.nodeModuleNameResolver(extendedConfig, combinePaths(basePath, 'tsconfig.json'), { moduleResolution.ModuleResolutionKind.NodeJs }, host, 
        /*cache*/ undefined, 
        /*projectRefs*/ undefined, 
        /*conditionsOrIsConfigLookup*/ tsGte5_3_0 ? undefined , 
        /*isConfigLookup*/ tsGte5_3_0 ? true );
...
/**
 * @internal
 * See also, which seems to do almost the same thing
 */
...
function getEncodedRootLength(path) {
    ...
    if (ch0 === 47 /* CharacterCodes.slash */ || ch0 === 92 /* CharacterCodes.backslash */) {
        ...
        const p1 = path.indexOf(ch0 === 47 /* CharacterCodes.slash */ ? directorySeparator , 2);
        if (p1 < 0)
...
function lastOrUndefined(array) {
    return array.length === 0 ? undefined [array.length - 1];
}
function last(array) {
