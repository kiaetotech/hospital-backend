...
/** @internal */
exports.createRequire = (_a = module_1.createRequire !== null && module_1.createRequire !== void 0 ? module_1.createRequire _1.createRequireFromPath) !== null && _a !== void 0 ? _a ('create-require');
/**
...
function yn(value) {
    var _a;
    return (_a = ynModule(value)) !== null && _a !== void 0 ? _a ;
}
exports.yn = yn;
/**
...
function attemptRequireWithV8CompileCache(requireFn, specifier) {
    try {
        ...
        try {
            ...
            v8CC === null || v8CC === void 0 ? void 0 .uninstall();
        }
    }
    catch (e) {
        return requireFn(specifier);
...
function createProjectLocalResolveHelper(localDirectory) {
    return function projectLocalResolveHelper(specifier, fallbackToTsNodeRelative) {
        return require.resolve(specifier, {
            paths? [localDirectory, __dirname]
                : [localDirectory],
        });
    };
}
...
function getBasePathForProjectLocalDependencyResolution(configFilePath, projectSearchDirOption, projectOption, cwdOption) {
    ...
    return (_a = projectSearchDirOption !== null && projectSearchDirOption !== void 0 ? projectSearchDirOption ) !== null && _a !== void 0 ? _a ;
