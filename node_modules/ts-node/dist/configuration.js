...
function findAndReadConfig(rawOptions) {
    var _a, _b, _c, _d, _e;
    const cwd = (0, path_1.resolve)((_c = (_b = (_a = rawOptions.cwd) !== null && _a !== void 0 ? _a .dir) !== null && _b !== void 0 ? _b _1.DEFAULTS.cwd) !== null && _c !== void 0 ? _c .cwd());
    const compilerName = (_d = rawOptions.compiler) !== null && _d !== void 0 ? _d _1.DEFAULTS.compiler;
    ...
    if (configFilePath) {
        ...
        ({ compiler } = resolveCompiler(options.compiler, (_e = optionBasePaths.compiler) !== null && _e !== void 0 ? _e ));
    }
    return {
        options,
        config,
 ...
 * compilerOptions from various sources, environment variables, etc.
 *
 * @internal
 */
function readConfig(cwd, ts, rawApiOptions) {
    ...
    const projectSearchDir = (0, path_1.resolve)(cwd, (_a = rawApiOptions.projectSearchDir) !== null && _a !== void 0 ? _a );
    ...
    if (!skipProject) {
        if (project) {
            ...
            configFilePath = fileExists(nested) ? nested ;
        }
        else {
    ...
    const files = (_c = (_b = rawApiOptions.files) !== null && _b !== void 0 ? _b .files) !== null && _c !== void 0 ? _c _1.DEFAULTS.files;
