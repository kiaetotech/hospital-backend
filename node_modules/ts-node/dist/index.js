...
Object.defineProperty(exports, "createRepl", { enumerable, get() { return repl_1.createRepl; } });
/**
 ...
 */
exports.DEFAULTS = {
    cwd: (_a = exports.env.TS_NODE_CWD) !== null && _a !== void 0 ? _a .env.TS_NODE_DIR,
    ...
    experimentalReplAwait: (_b = (0, util_1.yn)(exports.env.TS_NODE_EXPERIMENTAL_REPL_AWAIT)) !== null && _b !== void 0 ? _b ,
    tsTrace.log.bind(console),
};
/**
...
function register(serviceOrOpts) {
    ...
    if (!(serviceOrOpts === null || serviceOrOpts === void 0 ? void 0 [TS_NODE_SERVICE_BRAND])) {
...
function createFromPreloadedConfig(foundConfigResult) {
    ...
    if (options.swc && !options.typeCheck) {
        if (options.transpileOnly === false) {
            throw new Error("Cannot enable 'swc' option with 'transpileOnly'.  'swc' implies 'transpileOnly'.");
        }
    ...
    const configFileDirname = configFilePath ? (0, path_1.dirname)(configFilePath) ;
    const scopeDir = (_c = (_b = (_a = options.scopeDir) !== null && _a !== void 0 ? _a .options.rootDir) !== null && _b !== void 0 ? _b ) !== null && _c !== void 0 ? _c ;
    const ignoreBaseDir = configFileDirname !== null && configFileDirname !== void 0 ? configFileDirname ;
    ...
    function initializeTranspilerFactory() {
        ...
        if (transpiler) {
            ...
            const transpilerName = typeof transpiler === 'string' ? transpiler [0];
            ...
            function createTranspiler(compilerOptions, nodeModuleEmitKind) {
                return transpilerFactory === null || transpilerFactory === void 0 ? void 0 ({
                    service: {
                        options,
                        config: {
                            ...config,
    ...
    function installSourceMapSupport() {
        ...
        sourceMapSupport.install({
            ...
            retrieveFile(pathOrUrl) {
                ...
                // Notedoes not exist on early node v10
    ...
    const shouldHavePrettyErrors = options.pretty === undefined ? process.stdout.isTTY .pretty;
    ...
    function getEmitExtension(path) {
        ...
        if (lastDotIndex >= 0) {
            ...
            switch (ext) {
                case '.js''.ts''.js';
                case '.jsx''.tsx'jsxEmitPreserve ? '.jsx' : '.js';
                case '.mjs''.mts''.mjs';
                case '.cjs''.cts''.cjs';
            }
        }
        ...
        if (!options.compilerHost) {
            ...
            const getCustomTransformers = () => {
                if (typeof transformers === 'function') {
                    ...
                    return program ? transformers(program) ;
                }
                return transformers;
            };
            ...
            getOutput = (code, fileName) => {
                ...
                (0, exports.debug)('invariantservice.getProject() identical before and after getting emit output and diagnostics? (should always be true) ', programBefore === programAfter);
            ...
            let builderProgram = ts.createIncrementalProgram
                ? ts.createIncrementalProgram({
                    rootNames.from(rootFileNames),
                    options.options,
                    host,
                    configFileParsingDiagnostics.errors,
                    projectReferences.projectReferences,
                })
                .createEmitAndSemanticDiagnosticsBuilderProgram(Array.from(rootFileNames), config.options, host, undefined, config.errors, config.projectReferences);
            ...
            getTypeInfo = (code, fileName, position) => {
                ...
                return {
                    name.length
                        ...
                        .typeToString(type),
                    comment.displayPartsToString(symbol ? symbol.getDocumentationComment(checker) : []),
                };
            };
    ...
    function createTranspileOnlyGetOutputFunction(overrideModuleType, nodeModuleEmitKind) {
        ...
        let customTranspiler = createTranspiler === null || createTranspiler === void 0 ? void 0 (compilerOptions, nodeModuleEmitKind);
    ...
    function addDiagnosticFilter(filter) {
        diagnosticFilters.push({
            ...filter,
            filenamesAbsolute.filenamesAbsolute.map((f) => (0, util_1.normalizeSlashes)(f)),
        });
    }
    const getNodeEsmResolver = (0, util_1.once)(() => require('../dist-raw/node-internal-modules-esm-resolve').createResolve({
        ...
        tsNodeExperimentalSpecifierResolution.experimentalSpecifierResolution,
    }));
...
function updateOutput(outputText, fileName, sourceMap, getEmitExtension) {
    ...
    const sourceMapContent = `//# sourceMappingURL=data/json;charset=utf-8;base64,${base64Map}`;
    // Expected form: `//# sourceMappingURL=foo bar.js.map` or `//# sourceMappingURL=foo%20bar.js.map` for input file "foo bar.tsx"
    // Percent-encoding behavior added in TS 4.1.1://github.com/microsoft/TypeScript/issues/40951
 ...
 *
 * Reference://github.com/microsoft/TypeScript/blob/fcd9334f57d85b73dd66ad2d21c02e84822f4841/src/services/utilities.ts#L705-L731
 */
