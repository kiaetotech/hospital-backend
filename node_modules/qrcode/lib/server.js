...
function getRendererFromType (type) {
  switch (type) {
    case 'svg'SvgRenderer

    case 'txt''utf8'Utf8Renderer

    case 'png''image/png'PngRenderer
  }
}
...
exports.toString = function toString (text, opts, cb) {
  ...
  const type = params.opts ? params.opts.type const renderer = getStringRendererFromType(type)
