...
class UI {
  ...
  _rasterize (row) {
    ...
    row.forEach((col, c) => {
      ...
      col.width = widths[c]
      if (this.wrap) {
        wrapped = wrap(col.text, this._negatePadding(col), { hard}).split('\n')
      } else {
...
module.exports = function (opts = {}) {
  return new UI({
    width.width || getWindowWidth() || /* istanbul ignore next */ 80,
    wrap.wrap !== false
  })
}
