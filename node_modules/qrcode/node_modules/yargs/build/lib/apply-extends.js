...
function applyExtends(config, cwd, mergeExtends = false) {
    ...
    if (Object.prototype.hasOwnProperty.call(config, 'extends')) {
        ...
        defaultConfig = isPath ? JSON.parse(fs.readFileSync(pathToDefault, 'utf8')) (config.extends);
        delete config.extends;
        defaultConfig = applyExtends(defaultConfig, path.dirname(pathToDefault), mergeExtends);
    }
    previouslyVisitedConfigs = [];
    return mergeExtends ? mergeDeep(defaultConfig, config) .assign({}, defaultConfig, config);
}
