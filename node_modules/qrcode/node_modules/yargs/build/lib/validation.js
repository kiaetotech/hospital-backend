        ...
        if (demandedCommands._ && (_s < demandedCommands._.min || _s > demandedCommands._.max)) {
            if (_s < demandedCommands._.min) {
                if (demandedCommands._.minMsg !== undefined) {
                    ...
                    usage.fail(__n('Not enough non-option arguments%s, need at least %s', 'Not enough non-option arguments%s, need at least %s', _s, _s, demandedCommands._.min));
                }
            }
                ...
                if (demandedCommands._.maxMsg !== undefined) {
                    ...
                    usage.fail(__n('Too many non-option arguments%s, maximum of %s', 'Too many non-option arguments%s, maximum of %s', _s, _s, demandedCommands._.max));
                }
            }
        }
    };
    // validate the appropriate # of <required>
    // positional arguments were provided.positionalCount = function positionalCount(required, observed) {
        if (observed < required) {
            usage.fail(__n('Not enough non-option arguments%s, need at least %s', 'Not enough non-option arguments%s, need at least %s', observed, observed, required));
        }
    };
