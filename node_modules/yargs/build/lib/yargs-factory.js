var __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {
    ...
    return (kind === "a" ? f.call(receiver, value) ? f.value = value .set(receiver, value)), value;
};
var __classPrivateFieldGet = (this && this.__classPrivateFieldGet) || function (receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f === "a" ? f.call(receiver) ? f.value .get(receiver);
};
...
export class YargsInstance {
    ...
    addHelpOpt(opt, msg) {
        ...
        if (opt === false && msg === undefined)
            return this;
        __classPrivateFieldSet(this, _YargsInstance_helpOpt, typeof opt === 'string' ? opt , "f");
    ...
    check(f, global) {
        ...
        this.middleware((argv, _yargs) => {
            return maybeAsyncResult(() => {
                ...
                __classPrivateFieldGet(this, _YargsInstance_usage, "f").fail(err.message ? err.message .toString(), err);
                return argv;
            });
        }, false, global);
        return this;
    ...
    option(key, opt) {
        ...
        if (typeof key === 'object') {
            ...
            if (__classPrivateFieldGet(this, _YargsInstance_versionOpt, "f") && (key === 'version' || (opt === null || opt === void 0 ? void 0 .alias) === 'version')) {
                this[kEmitWarning]([
            ...
            if (opt.demandOption) {
                this.demandOption(key, typeof opt.demandOption === 'string' ? opt.demandOption );
            }
            if (opt.conflicts) {
    ...
    version(opt, msg, ver) {
        ...
        __classPrivateFieldSet(this, _YargsInstance_versionOpt, typeof opt === 'string' ? opt , "f");
    ...
    [kGetDollarZero]() {
        ...
        $0 = default$0
            ...
            return x.match(/^(\/|([a-zA-Z]:)?\\)/) && b.length < x.length ? b ;
        })
            .join(' ')
            .trim();
    ...
    getInternalMethods() {
        return {
            getCommandInstance[kGetCommandInstance].bind(this),
            getContext[kGetContext].bind(this),
            getHasOutput[kGetHasOutput].bind(this),
            getLoggerInstance[kGetLoggerInstance].bind(this),
            getParseContext[kGetParseContext].bind(this),
            getParserConfiguration[kGetParserConfiguration].bind(this),
            getUsageConfiguration[kGetUsageConfiguration].bind(this),
            getUsageInstance[kGetUsageInstance].bind(this),
            getValidationInstance[kGetValidationInstance].bind(this),
            hasParseCallback[kHasParseCallback].bind(this),
            isGlobalContext[kIsGlobalContext].bind(this),
            postProcess[kPostProcess].bind(this),
            reset[kReset].bind(this),
            runValidation[kRunValidation].bind(this),
            runYargsParserAndExecuteCommands[kRunYargsParserAndExecuteCommands].bind(this),
            setHasOutput[kSetHasOutput].bind(this),
        };
    }
    [kGetCommandInstance]() {
    ...
    [kReset](aliases = {}) {
        ...
        __classPrivateFieldSet(this, _YargsInstance_usage, __classPrivateFieldGet(this, _YargsInstance_usage, "f")
            ...
            (this, __classPrivateFieldGet(this, _YargsInstance_shim, "f")), "f");
        __classPrivateFieldSet(this, _YargsInstance_validation, __classPrivateFieldGet(this, _YargsInstance_validation, "f")
            ...
            (this, __classPrivateFieldGet(this, _YargsInstance_usage, "f"), __classPrivateFieldGet(this, _YargsInstance_shim, "f")), "f");
        __classPrivateFieldSet(this, _YargsInstance_command, __classPrivateFieldGet(this, _YargsInstance_command, "f")
            ...
            (__classPrivateFieldGet(this, _YargsInstance_usage, "f"), __classPrivateFieldGet(this, _YargsInstance_validation, "f"), __classPrivateFieldGet(this, _YargsInstance_globalMiddleware, "f"), __classPrivateFieldGet(this, _YargsInstance_shim, "f")), "f");
    ...
    [kRunYargsParserAndExecuteCommands](args, shortCircuit, calledFromCommand, commandIndex = 0, helpOnly = false) {
        ...
        const parsed = __classPrivateFieldGet(this, _YargsInstance_shim, "f").Parser.detailed(args, Object.assign({}, __classPrivateFieldGet(this, _YargsInstance_options, "f"), {
            configuration: { 'parse-positional-numbers', ...config },
        }));
        ...
        try {
            ...
            if (!skipValidation) {
                ...
                if (!requestCompletions) {
                    ...
                    argvPromise = this[kValidateAsync](validation, argvPromise !== null && argvPromise !== void 0 ? argvPromise );
        ...
        return this[kPostProcess](argvPromise !== null && argvPromise !== void 0 ? argvPromise , populateDoubleDash, !!calledFromCommand, true);
    }
