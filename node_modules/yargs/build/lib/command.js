...
export class CommandInstance {
    ...
    addDirectory(dir, req, callerFile, opts) {
        ...
        this.shim.requireDirectory({ require, filename}, dir, opts);
    }
    ...
    runCommand(command, yargs, parsed, commandIndex, helpOnly, helpOrVersionSet) {
        ...
        return isPromise(builderResult)
            ...
            .applyMiddlewareAndGetResult(isDefaultCommand, commandHandler, builderResult.innerArgv, currentContext, helpOnly, builderResult.aliases, yargs);
    }
        ...
        if (isCommandBuilderCallback(builder)) {
            ...
            if (isPromise(builderOutput)) {
                return builderOutput.then(output => {
                    innerYargs = isYargsInstance(output) ? output ;
    ...
    applyMiddlewareAndGetResult(isDefaultCommand, commandHandler, innerArgv, currentContext, helpOnly, aliases, yargs) {
        ...
        return isPromise(maybePromiseArgv)
            ...
            .handleValidationAndGetResult(isDefaultCommand, commandHandler, maybePromiseArgv, currentContext, aliases, yargs, middlewares, positionalMap);
    }
    ...
    isDefaulted(yargs, key) {
        const { default} = yargs.getOptions();
