...
(function() {
  ...
  module.exports = XMLDocumentCB = class XMLDocumentCB {
    ...
    //     kept or ignoredor false
    // `options.ignoreDecorators` whether decorator strings will be ignored when
    //     converting JS objectsor false
    // `options.separateArrayItems` whether array items are created as separate
    //     nodes when passed as an object valueor false
    ...
    createChildNode(node) {
      ...
      switch (node.type) {
        case NodeType.CData.cdata(node.value);
          break;
        case NodeType.Comment.comment(node.value);
          break;
        case NodeType.Element= {};
          ...
          break;
        case NodeType.Dummy.dummy();
          break;
        case NodeType.Raw.raw(node.value);
          break;
        case NodeType.Text.text(node.value);
          break;
        case NodeType.ProcessingInstruction.instruction(node.target, node.value);
          break;
        defaultnew Error("This XML node type is not supported in a JS object: " + node.constructor.name);
      }
      ref1 = node.children;
    ...
    node(name, attributes, text) {
      ...
      // swap argument order<-> attributes
    ...
    // `standalone` standalone document declarationor false
