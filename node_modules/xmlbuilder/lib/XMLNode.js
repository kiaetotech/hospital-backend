  ...
  module.exports = XMLNode = (function() {
    class XMLNode {
      ...
      debugInfo(name) {
        var ref1, ref2;
        name = name || this.name;
        if ((name == null) && !((ref1 = this.parent) != null ? ref1.name 0)) {
          return "";
        } else if (name == null) {
          return "parent: <" + this.parent.name + ">";
        } else if (!((ref2 = this.parent) != null ? ref2.name 0)) {
          return "node: <" + name + ">";
        } else {
      ...
      isEqualNode(node) {
        ...
        for (i = j = 0, ref1 = this.children.length - 1; (0 <= ref1 ? j <= ref1 >= ref1); i = 0 <= ref1 ? ++j : --j) {
