...
Object.defineProperty(Query, 'use$geoWithin', {
  get() { return $withinCmd == '$geoWithin'; },
  set(v) {
    if (true === v) {
      // mongodb >= 2.4
      $withinCmd = '$geoWithin';
 ...
 *     query.setOptions({ collection, read: 'primaryPreferred' });
 *
...
Query.prototype.box = function() {
  ...
  const conds = this._conditions[path] || (this._conditions[path] = {});
  conds[this._geoComparison || $withinCmd] = { $box};
  return this;
};
...
Query.prototype.polygon = function() {
  ...
  const conds = this._conditions[path] || (this._conditions[path] = {});
  conds[this._geoComparison || $withinCmd] = { $polygon};
  return this;
};
 ...
 * #### Example:
 *
 *     var area = { center: [50, 50], radius: 10, unique}
 *     query.where('loc').within().circle(area)
 *     query.center('loc', area);
 *
 *     // for spherical calculations
 *     var area = { center: [50, 50], radius: 10, unique, spherical}
 *     query.where('loc').within().circle(area)
 *     query.center('loc', area);
 *
 * @param {String} [path]
...
Query.prototype.geometry = function geometry() {
  ...
  const conds = this._conditions[path] || (this._conditions[path] = {});
  conds[this._geoComparison] = { $geometry};
...
Query.prototype.slaveOk = function(v) {
  this.options.slaveOk = arguments.length ? !!v ;
  return this;
};
 ...
 *     mquery().writeConcern({ w: 1, j, wtimeout: 2000 })
...
Query.prototype.writeConcern = Query.prototype.w = function writeConcern(concern) {
  if ('object' === typeof concern) {
    ...
    this.options.w = 'm' === concern ? 'majority' ;
  }
  return this;
};
 ...
 * #### Available options
 *
 * - `new`- true to return the modified document rather than the original. defaults to true
