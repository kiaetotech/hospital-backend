...
function getNodeData(node, strs, extendedData, structuredWriter) {
    ...
    switch (t) {
        case NODE_DATA_TYPE_CHILDRENt | common | getChildrenPropertyMask(node);
        case NODE_DATA_TYPE_STRINGt | common | recordNodeStrings(node, strs);
        case NODE_DATA_TYPE_EXTENDEDt | common | recordExtendedData(node, strs, extendedData, structuredWriter);
        defaultnew Error("unreachable");
    }
}
...
export function encodeNode(node) {
    ...
    // bytes 4-19(zero for non-SourceFile, we don't have access to xxh3 here)
    // byte 20-23options (zero for non-SourceFile)
