...
export class SourceFileCache {
    ...
    set(path, file, parseOptionsKey, contentHash, snapshotId, projectId) {
        ...
        entries.push({ file, contentHash, parseOptionsKey, refsSet([ref]) });
        this.trackPath(snapshotId, projectId, path);
        return file;
    }
    /**
     ...
     *   - Removed projects(don't retain any refs).
     *   - Changed projectsrefs for files not listed in changedFiles/deletedFiles.
     *   - Unchanged projectsall refs.
     */
