...
export default (function (option, Dayjs, dayjs) {
  ...
  dayjs.utc = function (date) {
    var cfg = {
      date,
      utc,
      args}; // eslint-disable-line prefer-rest-params
  ...
  proto.utcOffset = function (input, keepLocalTime) {
    ...
    var offset = Math.abs(input) <= 16 ? input * 60 ;
  ...
  var UTC_FORMAT_DEFAULT = 'YYYY-MM-DDTHH[Z]';
  ...
  proto.toDate = function (type) {
    if (type === 's' && this.$offset) {
      return dayjs(this.format('YYYY-MM-DD HH')).toDate();
    }
