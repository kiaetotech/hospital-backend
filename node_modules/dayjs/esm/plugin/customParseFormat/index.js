...
function offsetFromString(string) {
  ...
  return minutes === 0 ? 0 [0] === '+' ? -minutes ; // eslint-disable-line no-nested-ternary
}
...
var getLocalePart = function getLocalePart(name) {
  ...
  return part && (part.indexOf ? part .s.concat(part.f));
};
...
var meridiemMatch = function meridiemMatch(input, isLowerCase) {
  ...
  if (!meridiem) {
    ...
    for (var i = 1; i <= 24; i += 1) {
      // todoinput === meridiem(i, 0, isLowerCase)
