...
function plural(word, num) {
  ...
  return num % 10 === 1 && num % 100 !== 11 ? forms[0] % 10 >= 2 && num % 10 <= 4 && (num % 100 < 10 || num % 100 >= 20) ? forms[1] [2]; // eslint-disable-line
}

function relativeTimeWithPlural(number, withoutSuffix, key) {
  var format = {
    ss? 'секунда_секунды_секунд' : 'секунду_секунды_секунд',
    mm? 'хвіліна_хвіліны_хвілін' : 'хвіліну_хвіліны_хвілін',
    hh? 'гадзіна_гадзіны_гадзін' : 'гадзіну_гадзіны_гадзін',
    dd: 'дзень_дні_дзён',
...
var locale = {
  ...
  formats: {
    ...
    L: 'DD.MM.YYYY',
    LL: 'D MMMM YYYY г.',
    LLL: 'D MMMM YYYY г., HH',
    LLLL: 'dddd, D MMMM YYYY г., HH'
  },
  relativeTime: {
    future: 'праз %s',
    past: '%s таму',
