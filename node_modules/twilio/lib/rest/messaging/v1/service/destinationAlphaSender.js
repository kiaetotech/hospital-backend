...
class DestinationAlphaSenderContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyDestinationAlphaSenderInstance(operationVersion, response.body, instance._solution.serviceSid, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class DestinationAlphaSenderInstance {
    constructor(_version, payload, serviceSid, sid) {
        ...
        this._solution = { serviceSid, sid|| this.sid };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function DestinationAlphaSenderListInstance(version, serviceSid) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyDestinationAlphaSenderInstance(operationVersion, response.body, instance._solution.serviceSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyDestinationAlphaSenderPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyDestinationAlphaSenderPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
