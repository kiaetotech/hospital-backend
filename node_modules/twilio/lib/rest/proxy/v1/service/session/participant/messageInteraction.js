 ...
 *
 * NOTEclass is auto generated by OpenAPI Generator.
...
class MessageInteractionContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyMessageInteractionInstance(operationVersion, response.body, instance._solution.serviceSid, instance._solution.sessionSid, instance._solution.participantSid, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class MessageInteractionInstance {
    ...
    toJSON() {
        return {
            ...
            inboundParticipantSid.inboundParticipantSid,
            inboundResourceSid.inboundResourceSid,
            inboundResourceStatus.inboundResourceStatus,
            inboundResourceType.inboundResourceType,
            inboundResourceUrl.inboundResourceUrl,
            outboundParticipantSid.outboundParticipantSid,
            outboundResourceSid.outboundResourceSid,
            outboundResourceStatus.outboundResourceStatus,
            outboundResourceType.outboundResourceType,
            outboundResourceUrl.outboundResourceUrl,
...
function MessageInteractionListInstance(version, serviceSid, sessionSid, participantSid) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyMessageInteractionInstance(operationVersion, response.body, instance._solution.serviceSid, instance._solution.sessionSid, instance._solution.participantSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        // IMPORTANTfull response to Page constructor, not response.body
        let operationPromise = operationVersion
            .page({ uri._uri, method: "get", params, headers })
            .then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyMessageInteractionPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyMessageInteractionPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
