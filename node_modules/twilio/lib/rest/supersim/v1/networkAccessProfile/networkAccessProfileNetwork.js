...
class NetworkAccessProfileNetworkContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyNetworkAccessProfileNetworkInstance(operationVersion, response.body, instance._solution.networkAccessProfileSid, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class NetworkAccessProfileNetworkInstance {
    constructor(_version, payload, networkAccessProfileSid, sid) {
        ...
        this._solution = { networkAccessProfileSid, sid|| this.sid };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function NetworkAccessProfileNetworkListInstance(version, networkAccessProfileSid) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyNetworkAccessProfileNetworkInstance(operationVersion, response.body, instance._solution.networkAccessProfileSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyNetworkAccessProfileNetworkPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyNetworkAccessProfileNetworkPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
