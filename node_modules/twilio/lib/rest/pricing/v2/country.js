...
class CountryContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyCountryInstance(operationVersion, response.body, instance._solution.isoCountry),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class CountryInstance {
    constructor(_version, payload, isoCountry) {
        ...
        this._solution = { isoCountry|| this.isoCountry };
    }
    get _proxy() {
        this._context =
            this._context ||
    ...
    toJSON() {
        return {
            ...
            terminatingPrefixPrices.terminatingPrefixPrices,
            originatingCallPrices.originatingCallPrices,
            priceUnit.priceUnit,
            url.url,
        };
    }
...
function CountryListInstance(version) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyCountryPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyCountryPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
