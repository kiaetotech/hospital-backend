...
class LookupOverrideContextImpl {
    ...
    createWithHttpInfo(params, headers, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyLookupOverrideInstance(operationVersion, response.body, instance._solution.field, instance._solution.phoneNumber),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class LookupOverrideInstance {
    ...
    toJSON() {
        return {
            ...
            overriddenLineType.overriddenLineType,
            overrideReason.overrideReason,
            overrideTimestamp.overrideTimestamp,
            overriddenByAccountSid.overriddenByAccountSid,
            code.code,
            message.message,
            moreInfo.moreInfo,
            status.status,
