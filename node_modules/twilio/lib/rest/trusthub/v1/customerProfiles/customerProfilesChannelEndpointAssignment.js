...
class CustomerProfilesChannelEndpointAssignmentContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            .fetchWithResponseInfo({ uri._uri, method: "get", headers })
            .then((response) => ({
            ...response,
            bodyCustomerProfilesChannelEndpointAssignmentInstance(operationVersion, response.body, instance._solution.customerProfileSid, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class CustomerProfilesChannelEndpointAssignmentInstance {
    constructor(_version, payload, customerProfileSid, sid) {
        ...
        this._solution = { customerProfileSid, sid|| this.sid };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function CustomerProfilesChannelEndpointAssignmentListInstance(version, customerProfileSid) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, callback) {
        ...
        // CREATE, FETCH, UPDATE operations
        let operationPromise = operationVersion
            .createWithResponseInfo({ uri._uri, method: "post", data, headers })
            .then((response) => ({
            ...response,
            bodyCustomerProfilesChannelEndpointAssignmentInstance(operationVersion, response.body, instance._solution.customerProfileSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyCustomerProfilesChannelEndpointAssignmentPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyCustomerProfilesChannelEndpointAssignmentPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
