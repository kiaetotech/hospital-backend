...
class ComplianceRegistrationInquiriesContextImpl {
    ...
    updateWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyComplianceRegistrationInquiriesInstance(operationVersion, response.body, instance._solution.registrationId),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class ComplianceRegistrationInquiriesInstance {
    constructor(_version, payload, registrationId) {
        ...
        this._solution = { registrationId|| this.registrationId };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function ComplianceRegistrationInquiriesListInstance(version) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyComplianceRegistrationInquiriesInstance(operationVersion, response.body),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
