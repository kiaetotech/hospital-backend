...
class ComplianceInquiriesContextImpl {
    ...
    updateWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyComplianceInquiriesInstance(operationVersion, response.body, instance._solution.customerId),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class ComplianceInquiriesInstance {
    constructor(_version, payload, customerId) {
        ...
        this._solution = { customerId|| this.customerId };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function ComplianceInquiriesListInstance(version) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyComplianceInquiriesInstance(operationVersion, response.body),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
