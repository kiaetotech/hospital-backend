...
class RoomRecordingContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyRoomRecordingInstance(operationVersion, response.body, instance._solution.roomSid, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class RoomRecordingInstance {
    constructor(_version, payload, roomSid, sid) {
        ...
        this._solution = { roomSid, sid|| this.sid };
    }
    get _proxy() {
        this._context =
            this._context ||
    ...
    toJSON() {
        return {
            ...
            codec.codec,
            groupingSids.groupingSids,
            trackName.trackName,
            offset.offset,
            mediaExternalLocation.mediaExternalLocation,
            roomSid.roomSid,
            links.links,
        };
    }
...
function RoomRecordingListInstance(version, roomSid) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyRoomRecordingPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyRoomRecordingPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
