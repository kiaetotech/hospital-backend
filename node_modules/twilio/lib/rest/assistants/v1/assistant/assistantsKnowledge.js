...
class AssistantsKnowledgeContextImpl {
    ...
    createWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyAssistantsKnowledgeInstance(operationVersion, response.body, instance._solution.assistantId, instance._solution.id),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class AssistantsKnowledgeInstance {
    constructor(_version, payload, assistantId, id) {
        ...
        this._solution = { assistantId, id|| this.id };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function AssistantsKnowledgeListInstance(version, assistantId) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyAssistantsKnowledgePage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyAssistantsKnowledgePage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
