...
class AddOnResultContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyAddOnResultInstance(operationVersion, response.body, instance._solution.accountSid, instance._solution.referenceSid, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class AddOnResultInstance {
    constructor(_version, payload, accountSid, referenceSid, sid) {
        ...
        this._solution = { accountSid, referenceSid, sid|| this.sid };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function AddOnResultListInstance(version, accountSid, referenceSid) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyAddOnResultPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyAddOnResultPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
