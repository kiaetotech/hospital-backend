...
class MemberContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyMemberInstance(operationVersion, response.body, instance._solution.accountSid, instance._solution.queueSid, instance._solution.callSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class MemberInstance {
    constructor(_version, payload, accountSid, queueSid, callSid) {
        ...
        this._solution = { accountSid, queueSid, callSid|| this.callSid };
    }
    get _proxy() {
        this._context =
            this._context ||
