...
class RecordingContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyRecordingInstance(operationVersion, response.body, instance._solution.accountSid, instance._solution.conferenceSid, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class RecordingInstance {
    constructor(_version, payload, accountSid, conferenceSid, sid) {
        ...
        this._solution = { accountSid, conferenceSid, sid|| this.sid };
    }
    get _proxy() {
        this._context =
            this._context ||
