...
class ConfiguredPluginContextImpl {
    ...
    fetchWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyConfiguredPluginInstance(operationVersion, response.body, instance._solution.configurationSid, instance._solution.pluginSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class ConfiguredPluginInstance {
    ...
    toJSON() {
        return {
            ...
            pluginSid.pluginSid,
            pluginVersionSid.pluginVersionSid,
            phase.phase,
            pluginUrl.pluginUrl,
            uniqueName.uniqueName,
            friendlyName.friendlyName,
            description.description,
            pluginArchived.pluginArchived,
            version.version,
            changelog.changelog,
            pluginVersionArchived.pluginVersionArchived,
            _private._private,
...
function ConfiguredPluginListInstance(version, configurationSid) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyConfiguredPluginPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyConfiguredPluginPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
