...
function InsightsSegmentsListInstance(version) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyInsightsSegmentsPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyInsightsSegmentsPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
...
class InsightsSegmentsInstance {
    ...
    toJSON() {
        return {
            ...
            externalSegmentLinkId.externalSegmentLinkId,
            date.date,
            accountId.accountId,
            externalSegmentLink.externalSegmentLink,
            agentId.agentId,
            agentPhone.agentPhone,
            agentName.agentName,
            agentTeamName.agentTeamName,
            agentTeamNameInHierarchy.agentTeamNameInHierarchy,
            agentLink.agentLink,
            customerPhone.customerPhone,
            customerName.customerName,
            customerLink.customerLink,
            segmentRecordingOffset.segmentRecordingOffset,
            media.media,
