...
class ConfigurationContextImpl {
    ...
    fetchWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyConfigurationInstance(operationVersion, response.body),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class ConfigurationInstance {
    ...
    toJSON() {
        return {
            ...
            taskrouterTargetWorkflowSid.taskrouterTargetWorkflowSid,
            taskrouterTargetTaskqueueSid.taskrouterTargetTaskqueueSid,
            taskrouterTaskqueues.taskrouterTaskqueues,
            taskrouterSkills.taskrouterSkills,
            taskrouterWorkerChannels.taskrouterWorkerChannels,
            taskrouterWorkerAttributes.taskrouterWorkerAttributes,
            taskrouterOfflineActivitySid.taskrouterOfflineActivitySid,
            runtimeDomain.runtimeDomain,
            messagingServiceInstanceSid.messagingServiceInstanceSid,
            chatServiceInstanceSid.chatServiceInstanceSid,
            flexServiceInstanceSid.flexServiceInstanceSid,
            flexInstanceSid.flexInstanceSid,
            ...
            callRecordingWebhookUrl.callRecordingWebhookUrl,
            crmEnabled.crmEnabled,
            crmType.crmType,
            crmCallbackUrl.crmCallbackUrl,
            crmFallbackUrl.crmFallbackUrl,
            crmAttributes.crmAttributes,
            publicAttributes.publicAttributes,
            pluginServiceEnabled.pluginServiceEnabled,
            pluginServiceAttributes.pluginServiceAttributes,
            integrations.integrations,
            outboundCallFlows.outboundCallFlows,
            serverlessServiceSids.serverlessServiceSids,
            queueStatsConfiguration.queueStatsConfiguration,
            notifications.notifications,
            markdown.markdown,
            url.url,
            flexInsightsHr.flexInsightsHr,
            flexInsightsDrilldown.flexInsightsDrilldown,
            flexUrl.flexUrl,
            channelConfigs.channelConfigs,
            debuggerIntegration.debuggerIntegration,
            flexUiStatusReport.flexUiStatusReport,
            agentConvEndMethods.agentConvEndMethods,
