...
class WebhookContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyWebhookInstance(operationVersion, response.body, instance._solution.conversationSid, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class WebhookInstance {
    constructor(_version, payload, conversationSid, sid) {
        ...
        this._solution = { conversationSid, sid|| this.sid };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function WebhookListInstance(version, conversationSid) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyWebhookInstance(operationVersion, response.body, instance._solution.conversationSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
