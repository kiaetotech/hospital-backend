...
class ConfigurationContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyConfigurationInstance(operationVersion, response.body, instance._solution.chatServiceSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class ConfigurationInstance {
    ...
    toJSON() {
        return {
            ...
            defaultConversationCreatorRoleSid.defaultConversationCreatorRoleSid,
            defaultConversationRoleSid.defaultConversationRoleSid,
            defaultChatServiceRoleSid.defaultChatServiceRoleSid,
            url.url,
            links.links,
