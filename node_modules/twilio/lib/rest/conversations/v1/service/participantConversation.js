...
function ParticipantConversationListInstance(version, chatServiceSid) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyParticipantConversationPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyParticipantConversationPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
...
class ParticipantConversationInstance {
    ...
    toJSON() {
        return {
            ...
            participantMessagingBinding.participantMessagingBinding,
            ...
            conversationDateUpdated.conversationDateUpdated,
            conversationCreatedBy.conversationCreatedBy,
            conversationState.conversationState,
            conversationTimers.conversationTimers,
            links.links,
        };
    }
