...
class ConfigurationContextImpl {
    ...
    removeWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyConfigurationInstance(operationVersion, response.body, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class ConfigurationInstance {
    ...
    toJSON() {
        return {
            ...
            conversationGroupingType.conversationGroupingType,
            memoryStoreId.memoryStoreId,
            channelSettings.channelSettings,
            statusCallbacks.statusCallbacks,
            intelligenceConfigurationIds.intelligenceConfigurationIds,
            memoryExtractionEnabled.memoryExtractionEnabled,
            conversationsV1Bridge.conversationsV1Bridge,
            createdAt.createdAt,
            updatedAt.updatedAt,
            version.version,
        };
...
function ConfigurationListInstance(version) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyConfigurationPage(operationVersion, response, instance._uri, data, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyConfigurationPage(instance._version, response, instance._uri, {}, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
