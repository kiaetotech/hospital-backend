...
class ConferenceParticipantContextImpl {
    ...
    fetchWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyConferenceParticipantInstance(operationVersion, response.body, instance._solution.conferenceSid, instance._solution.participantSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class ConferenceParticipantInstance {
    ...
    toJSON() {
        return {
            ...
            outboundQueueLength.outboundQueueLength,
            outboundTimeInQueue.outboundTimeInQueue,
            jitterBufferSize.jitterBufferSize,
            isCoach.isCoach,
            coachedParticipants.coachedParticipants,
...
function ConferenceParticipantListInstance(version, conferenceSid) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyConferenceParticipantPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyConferenceParticipantPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
