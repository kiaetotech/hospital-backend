...
class RoomContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyRoomInstance(operationVersion, response.body, instance._solution.roomSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class RoomInstance {
    constructor(_version, payload, roomSid) {
        ...
        this._solution = { roomSid|| this.roomSid };
    }
    get _proxy() {
        this._context =
            this._context ||
    ...
    toJSON() {
        return {
            ...
            uniqueParticipantIdentities.uniqueParticipantIdentities,
            concurrentParticipants.concurrentParticipants,
            maxConcurrentParticipants.maxConcurrentParticipants,
            codecs.codecs,
            mediaRegion.mediaRegion,
            durationSec.durationSec,
            totalParticipantDurationSec.totalParticipantDurationSec,
            totalRecordingDurationSec.totalRecordingDurationSec,
