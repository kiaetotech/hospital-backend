...
class OutboundContextImpl {
    ...
    createWithHttpInfo(params, headers, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyOutboundInstance(operationVersion, response.body, instance._solution.reportId),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class OutboundInstance {
    constructor(_version, payload, reportId) {
        ...
        this.answeringMachineDetection =
            payload.answering_machine_detection !== null &&
                ...
                ;
        this._solution = { reportId|| this.reportId };
    }
    get _proxy() {
        this._context =
            this._context ||
    ...
    toJSON() {
        return {
            ...
            callAnswerScore.callAnswerScore,
            callStatePercentage.callStatePercentage,
            silentCallsPercentage.silentCallsPercentage,
            callsByDeviceType.callsByDeviceType,
            answerRateDeviceType.answerRateDeviceType,
            blockedCallsByCarrier.blockedCallsByCarrier,
            shortDurationCallsPercentage.shortDurationCallsPercentage,
            longDurationCallsPercentage.longDurationCallsPercentage,
            potentialRobocallsPercentage.potentialRobocallsPercentage,
...
function OutboundListInstance(version, reportId) {
    ...
    instance.pageWithHttpInfo = function pageWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            headers.headers,
            bodyOutboundPage(operationVersion, response, instance._solution),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPageWithHttpInfo = function getPageWithHttpInfo(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((response) => ({
            statusCode.statusCode,
            headers.headers,
            bodyOutboundPage(instance._version, response, instance._solution),
        }));
        pagePromise = instance._version.setPromiseCallback(pagePromise, callback);
        return pagePromise;
    };
