...
class PortingPortInContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyPortingPortInInstance(operationVersion, response.body, instance._solution.portInRequestSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class PortingPortInInstance {
    ...
    toJSON() {
        return {
            ...
            targetPortInDate.targetPortInDate,
            targetPortInTimeRangeStart.targetPortInTimeRangeStart,
            targetPortInTimeRangeEnd.targetPortInTimeRangeEnd,
            ...
            bundleSid.bundleSid,
            portabilityAdvanceCarrier.portabilityAdvanceCarrier,
            autoCancelApprovalNumbers.autoCancelApprovalNumbers,
            documents.documents,
...
function PortingPortInListInstance(version) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, headers, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyPortingPortInInstance(operationVersion, response.body),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
