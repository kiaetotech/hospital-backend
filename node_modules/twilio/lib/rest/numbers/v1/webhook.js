...
function WebhookListInstance(version) {
    ...
    instance.fetchWithHttpInfo = function fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyWebhookInstance(operationVersion, response.body),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
...
class WebhookInstance {
    ...
    toJSON() {
        return {
            url.url,
            portInTargetUrl.portInTargetUrl,
            portOutTargetUrl.portOutTargetUrl,
            notificationsOf.notificationsOf,
            portInTargetDateCreated.portInTargetDateCreated,
            portOutTargetDateCreated.portOutTargetDateCreated,
        };
    }
