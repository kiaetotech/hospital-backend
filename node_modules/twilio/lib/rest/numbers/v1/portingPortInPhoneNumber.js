...
class PortingPortInPhoneNumberContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyPortingPortInPhoneNumberInstance(operationVersion, response.body, instance._solution.portInRequestSid, instance._solution.phoneNumberSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class PortingPortInPhoneNumberInstance {
    ...
    toJSON() {
        return {
            ...
            portable.portable,
            notPortabilityReason.notPortabilityReason,
            notPortabilityReasonCode.notPortabilityReasonCode,
            portInPhoneNumberStatus.portInPhoneNumberStatus,
            portOutPin.portOutPin,
