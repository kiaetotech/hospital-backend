...
class BulkEligibilityContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyBulkEligibilityInstance(operationVersion, response.body, instance._solution.requestId),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class BulkEligibilityInstance {
    constructor(_version, payload, requestId) {
        ...
        this._solution = { requestId|| this.requestId };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function BulkEligibilityListInstance(version) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, headers, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyBulkEligibilityInstance(operationVersion, response.body),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
