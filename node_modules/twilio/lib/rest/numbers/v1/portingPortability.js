...
class PortingPortabilityContextImpl {
    ...
    fetchWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyPortingPortabilityInstance(operationVersion, response.body, instance._solution.phoneNumber),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class PortingPortabilityInstance {
    constructor(_version, payload, phoneNumber) {
        ...
        this._solution = { phoneNumber|| this.phoneNumber };
    }
    get _proxy() {
        this._context =
            this._context ||
    ...
    toJSON() {
        return {
            ...
            portable.portable,
            pinAndAccountNumberRequired.pinAndAccountNumberRequired,
            notPortableReason.notPortableReason,
            notPortableReasonCode.notPortableReasonCode,
