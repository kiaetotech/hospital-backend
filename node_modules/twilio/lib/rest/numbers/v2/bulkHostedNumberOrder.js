...
class BulkHostedNumberOrderContextImpl {
    ...
    fetchWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyBulkHostedNumberOrderInstance(operationVersion, response.body, instance._solution.bulkHostingSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class BulkHostedNumberOrderInstance {
    constructor(_version, payload, bulkHostingSid) {
        ...
        this._solution = { bulkHostingSid|| this.bulkHostingSid };
    }
    get _proxy() {
        this._context =
            this._context ||
...
function BulkHostedNumberOrderListInstance(version) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, headers, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyBulkHostedNumberOrderInstance(operationVersion, response.body),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
