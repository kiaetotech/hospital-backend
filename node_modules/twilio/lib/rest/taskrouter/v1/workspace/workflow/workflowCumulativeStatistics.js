...
class WorkflowCumulativeStatisticsContextImpl {
    ...
    fetchWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyWorkflowCumulativeStatisticsInstance(operationVersion, response.body, instance._solution.workspaceSid, instance._solution.workflowSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class WorkflowCumulativeStatisticsInstance {
    ...
    toJSON() {
        return {
            ...
            avgTaskAcceptanceTime.avgTaskAcceptanceTime,
            startTime.startTime,
            endTime.endTime,
            ...
            reservationsTimedOut.reservationsTimedOut,
            reservationsCanceled.reservationsCanceled,
            reservationsRescinded.reservationsRescinded,
            splitByWaitTime.splitByWaitTime,
            waitDurationUntilAccepted.waitDurationUntilAccepted,
            waitDurationUntilCanceled.waitDurationUntilCanceled,
            tasksCanceled.tasksCanceled,
            tasksCompleted.tasksCompleted,
            tasksEntered.tasksEntered,
            tasksDeleted.tasksDeleted,
            tasksMoved.tasksMoved,
            tasksTimedOutInWorkflow.tasksTimedOutInWorkflow,
