...
class ReservationContextImpl {
    ...
    fetchWithHttpInfo(callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyReservationInstance(operationVersion, response.body, instance._solution.workspaceSid, instance._solution.taskSid, instance._solution.sid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class ReservationInstance {
    constructor(_version, payload, workspaceSid, taskSid, sid) {
        ...
        this._solution = { workspaceSid, taskSid, sid|| this.sid };
    }
    get _proxy() {
        this._context =
            this._context ||
