...
class TaskQueueRealTimeStatisticsContextImpl {
    ...
    fetchWithHttpInfo(params, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyTaskQueueRealTimeStatisticsInstance(operationVersion, response.body, instance._solution.workspaceSid, instance._solution.taskQueueSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
...
class TaskQueueRealTimeStatisticsInstance {
    ...
    toJSON() {
        return {
            ...
            longestTaskWaitingSid.longestTaskWaitingSid,
            longestRelativeTaskAgeInQueue.longestRelativeTaskAgeInQueue,
            longestRelativeTaskSidInQueue.longestRelativeTaskSidInQueue,
            taskQueueSid.taskQueueSid,
            tasksByPriority.tasksByPriority,
            tasksByStatus.tasksByStatus,
            totalAvailableWorkers.totalAvailableWorkers,
            totalEligibleWorkers.totalEligibleWorkers,
