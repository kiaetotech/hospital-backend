...
function TaskQueueBulkRealTimeStatisticsListInstance(version, workspaceSid) {
    ...
    instance.createWithHttpInfo = function createWithHttpInfo(params, headers, callback) {
        ...
        let operationPromise = operationVersion
            ...
            .then((response) => ({
            ...response,
            bodyTaskQueueBulkRealTimeStatisticsInstance(operationVersion, response.body, instance._solution.workspaceSid),
        }));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
...
class TaskQueueBulkRealTimeStatisticsInstance {
    ...
    toJSON() {
        return {
            ...
            taskQueueData.taskQueueData,
            taskQueueResponseCount.taskQueueResponseCount,
            url.url,
        };
    }
