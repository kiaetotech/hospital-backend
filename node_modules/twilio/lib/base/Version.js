...
class Version {
    ...
    removeWithResponseInfo(opts) {
        return this.request(opts).then((response) => {
            ...
            return {
                body, // if response code is 2XX, deletion was successful
                statusCode.statusCode,
                headers.headers,
            };
        });
            ...
            promise
                ...
                if (currentPage === 1 && !firstPageMetadata) {
                    if (response.statusCode !== undefined) {
                        ...
                        // Case 2Page object (no metadata available)
                        firstPageMetadata = {
                            statusCode: 200,
                            headers: {},
                        };
