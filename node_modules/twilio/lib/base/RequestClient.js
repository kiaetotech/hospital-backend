...
class RequestClient {
    ...
    constructor(opts) {
        ...
        let agentOpts = {
            ...
            maxSockets.maxSockets || DEFAULT_MAX_SOCKETS, // no of sockets open per host
            maxTotalSockets.maxTotalSockets || DEFAULT_MAX_TOTAL_SOCKETS, // no of sockets open in total
            maxFreeSockets.maxFreeSockets || DEFAULT_MAX_FREE_SOCKETS, // no of free sockets open per host
        ...
        if (process.env.HTTP_PROXY) {
            // Noteprocess.env.HTTP_PROXY is set, we're not able to apply the given
            // socket timeout. See://github.com/TooTallNate/node-https-proxy-agent/pull/96
        ...
        if (opts.autoRetry) {
            this.axios.interceptors.response.use(getExponentialBackoffResponseHandler(this.axios, {
                maxIntervalMillis.maxRetryDelay,
