...
class Page {
    ...
    getPreviousPageUrl() {
        if (this._payload.meta &&
            ...
            // jshint ignorereturn this._payload.meta.previous_page_url; // jshint ignore}
        if ("previous_page_uri" in this._payload &&
            this._payload.previous_page_uri) {
            // jshint ignorereturn this._version._domain.absoluteUrl(this._payload.previous_page_uri); // jshint ignore}
        return undefined;
    }
    /**
    ...
    getNextPageUrl() {
        if (this._payload.meta &&
            ...
            // jshint ignorereturn this._payload.meta.next_page_url; // jshint ignore}
        if ("next_page_uri" in this._payload && this._payload.next_page_uri) {
            // jshint ignorereturn this._version._domain.absoluteUrl(this._payload.next_page_uri); // jshint ignore}
        return undefined;
    }
    /**
