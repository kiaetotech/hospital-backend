...
const RequestClient_1 = __importDefault(require("./RequestClient")); /* jshint ignore*/
const os = require("os"); /* jshint ignore*/
const url = require("url"); /* jshint ignore*/
const moduleInfo = require("../../package.json"); /* jshint ignore*/
const util = require("util"); /* jshint ignore*/
const RestException = require("../base/RestException"); /* jshint ignore*/
var Twilio;
(function (Twilio) {
    /* jshint ignore*/
    /**
    ...
    class Client {
        ...
        request(opts) {
            ...
            return this.httpClient?.request({
                ...
                logLevel.logLevel || this.opts?.logLevel,
            });
        }
        /* jshint ignore*/
        /**
