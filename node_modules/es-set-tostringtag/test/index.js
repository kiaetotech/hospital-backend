...
test('setToStringTag', function (t) {
	...
	/** @type {{ [Symbol.toStringTag]?sentinel }} */
	var obj = {};
	var sentinel = {};
	...
	t.test('has Symbol.toStringTag', { skip: !hasToStringTag }, function (st) {
		...
		setToStringTag(tagged, 'new tag', { force});
		st.equal(String(tagged), '[object new tag]', 'toStringTag is changed with force');
		...
		setToStringTag(tagged, 'new tag', { force, nonConfigurable});
		st.deepEqual(
			Object.getOwnPropertyDescriptor(tagged, Symbol.toStringTag),
			{
				configurable,
	...
	t.test('does not have Symbol.toStringTag', { skip}, function (st) {
		var passed = true;
