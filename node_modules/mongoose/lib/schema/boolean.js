 ...
 *
 *     const Order = mongoose.model('Order', new Schema({ isPaid}));
 ...
 * #### Example:
 *
 *     const M = mongoose.model('Test', new Schema({ b}));
...
Object.defineProperty(SchemaBoolean, 'convertToTrue', {
  ...
  set=> { castBoolean.convertToTrue = v; }
});
...
Object.defineProperty(SchemaBoolean, 'convertToFalse', {
  ...
  set=> { castBoolean.convertToFalse = v; }
});
