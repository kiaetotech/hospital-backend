 ...
 *
 *     const Order = mongoose.model('Order', new Schema({ amount}));
 ...
 * #### Example:
 *
 *     const s = new Schema({ n: { type, min: 10 })
 ...
 *     const schema = new Schema({ n: { type, min})
 *     const M = mongoose.model('Measurement', schema);
 *     const s= new M({ n: 4 });
 *     s.validate(function (err) {
 *       console.log(String(err)) // ValidationErrorvalue of path `n` (4) is beneath the limit (10).
 *     })
 *
...
SchemaNumber.prototype.min = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    ...
    this.validators.push({
      validator.minValidator = function(v) {
 ...
 * #### Example:
 *
 *     const s = new Schema({ n: { type, max: 10 })
 *     const M = db.model('M', s)
 *     const m = new M({ n: 11 })
 *     m.save(function (err) {
 *       console.error(err) // validator error
 ...
 *     const schema = new Schema({ n: { type, max})
 *     const M = mongoose.model('Measurement', schema);
 *     const s= new M({ n: 4 });
 *     s.validate(function (err) {
 *       console.log(String(err)) // ValidationErrorvalue of path `n` (4) exceeds the limit (10).
 *     })
 *
...
SchemaNumber.prototype.max = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    ...
    this.validators.push({
      validator.maxValidator = function(v) {
        return v == null || v <= value;
      },
      message,
      type: 'max',
 ...
 * #### Example:
 *
 *     const s = new Schema({ n: { type, enum: [1, 2, 3] });
 *     const M = db.model('M', s);
 *
 *     const m = new M({ n: 4 });
...
SchemaNumber.prototype.enum = function(values, message) {
  ...
  message = message == null ? MongooseError.messages.Number.enum ;
