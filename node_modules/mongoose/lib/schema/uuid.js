...
SchemaUUID._cast = function(value) {
  ...
  // Re-647 and gh-3030, we're ok with casting using `toString()`
 ...
 *     new Model({ test.v4() }).test; // UUID with all uppercase
 *
 ...
 *
 *     const User = mongoose.model('User', new Schema({ test.UUID }));
