  ...
  if (op['insertOne']) {
    ...
    return (callback) => {
      try {
        ...
        const strict = options.strict != null ? options.strict .schema.options.strict;
        ...
        const shouldSetDefaultsOnInsert = op['updateOne'].setDefaultsOnInsert == null ?
          globalSetDefaultsOnInsert ['updateOne'].setDefaultsOnInsert;
    ...
    return (callback) => {
      try {
        ...
        const shouldSetDefaultsOnInsert = op['updateMany'].setDefaultsOnInsert == null ?
          globalSetDefaultsOnInsert ['updateMany'].setDefaultsOnInsert;
