...
module.exports = function discriminator(model, name, schema, tiedValue, applyPlugins, mergeHooks) {
  ...
  mergeHooks = mergeHooks == null ? true ;
  ...
  function merge(schema, baseSchema) {
    ...
    // Find conflicting pathssomething is a path in the base schema
    ...
    // Clean up conflicting paths _after_ merging re-6076
    ...
    obj[key] = {
      ...
      $skipDiscriminatorCheck};
    obj[key][schema.options.typeKey] = existingPath ? existingPath.options[schema.options.typeKey] ;
    schema.add(obj);

    schema.discriminatorMapping = { key, value, isRoot};
  ...
  if (!model.schema.discriminatorMapping) {
    model.schema.discriminatorMapping = { key, value, isRoot};
  }
