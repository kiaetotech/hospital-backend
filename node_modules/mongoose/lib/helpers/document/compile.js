...
function compile(tree, proto, prefix, options) {
  ...
  for (const key of Object.keys(tree)) {
    ...
    const subprops = hasSubprops ? limb ;

    defineKey({ prop, subprops, prototype, prefix, options});
  }
}
...
function defineKey({ prop, subprops, prototype, prefix, options }) {
  ...
  prefix = prefix || '';
  const useGetOptions = prefix ? Object.freeze({}) ;
      ...
      get() {
        ...
        if (!this.$__.getters[path]) {
          ...
          Object.defineProperty(nested, '$__get', {
            ...
            value() {
              return _this.get(path, null, {
                virtuals&& this.schema && this.schema.options && this.schema.options.toObject && this.schema.options.toObject.virtuals || null
              });
            }
          });
          ...
          Object.defineProperty(nested, 'toJSON', {
            ...
            value() {
              return _this.get(path, null, {
                virtuals&& this.schema && this.schema.options && this.schema.options.toJSON && this.schema.options.toJSON.virtuals || null
              });
            }
          });
