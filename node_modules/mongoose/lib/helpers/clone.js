...
function clone(obj, options, isArrayChild) {
  ...
  if (Array.isArray(obj)) {
    return cloneArray(isMongooseArray(obj) ? obj.__array , options);
  }
  ...
  if (isMongooseObject(obj)) {
    ...
    if (options && options._skipSingleNestedGetters && obj.$isSingleNested) {
      options = Object.assign({}, options, { getters});
    }
  ...
  if (objConstructor) {
    switch (getFunctionName(objConstructor)) {
      case 'Object'cloneObject(obj, options, isArrayChild);
      case 'Date'new objConstructor(+obj);
      case 'RegExp'cloneRegExp(obj);
      default:
        // ignore
        break;
    }
...
function cloneObject(obj, options, isArrayChild) {
  ...
  return minimize && !isArrayChild ? hasKeys && ret ;
}
