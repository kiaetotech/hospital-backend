...
function _castArrayFilters(arrayFilters, schema, strictQuery, updatedPathsByFilter, query) {
  ...
  for (const filter of arrayFilters) {
    ...
    const filterWildcardPath = dot === -1 ? firstKey .substring(0, dot);
    ...
    let filterBaseSchema = baseSchematype != null ? baseSchematype.schema ;
    ...
    for (const key of keys) {
      ...
      let filterPathRelativeToBase = dot === -1 ? null .substring(dot);
      let schematype;
      ...
      if (schematype == null) {
        ...
        const filterPath = filterPathRelativeToBase == null ?
          baseFilterPath + '.0' + '.0' + filterPathRelativeToBase;
