...
module.exports = function setupTimestamps(schema, timestamps) {
  ...
  if (createdAt && !schema.paths[createdAt]) {
    const baseImmutableCreatedAt = schema.base != null ? schema.base.get('timestamps.createdAt.immutable') ;
    const immutable = baseImmutableCreatedAt != null ? baseImmutableCreatedAt ;
    schemaAdditions[createdAt] = { [schema.options.typeKey || 'type'], immutable };
  }
  ...
  schema.methods.initializeTimestamps = function() {
    const ts = currentTime != null ?
      currentTime() .constructor.base.now();
