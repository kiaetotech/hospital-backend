...
class ValidatorError extends MongooseError {
  ...
  /**
   * Ensure `name` and `message` show up in toJSON output re-9296
   * @api private
   */

  toJSON() {
    return Object.assign({ name.name, message.message }, this);
  }
}
 ...
 * it from `require('util').inspect()` output re-3925
 * @api private
 */
