 ...
 *
 * - `value`value returned by the previous getter. If there is only one getter, `value` will be `undefined`.
 * - `virtual`virtual object you called `.get()` on.
 * - `doc`document this virtual is attached to. Equivalent to `this`.
 *
 * #### Example:
 *
 ...
 * - `virtual`virtual object you're calling `.set()` on.
 * - `doc`document this virtual is attached to. Equivalent to `this`.
 *
 * #### Example:
 *
