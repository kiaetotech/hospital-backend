...
exports.merge = function merge(to, from, options, path) {
  ...
  while (i < len) {
    ...
    if (to[key] == null) {
      ...
      merge(to[key], from[key], options, path ? path + '.' + key );
 ...
 * ObjectId, etc.
 *
 * `Object.getPrototypeOf()` is part of ES5://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/getPrototypeOf
 *
...
exports.populate = function populate(path, select, model, match, options, subPopulate, justOne, count) {
  ...
  if (typeof obj.path !== 'string') {
    throw new TypeError('utils.populatepath. Expected string. Got typeof `' + typeof path + '`');
  }
...
const mapGetterOptions = Object.freeze({ getters});
