...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" obj; };
...
function normalizeDate(date) {
  return isNumber(date) ? date (date);
}
...
function validateWebhookSignature(body, signature, secret) {
  ...
  if (!isDefined(body) || !isDefined(signature) || !isDefined(secret)) {
    ...
    throw Error("Invalid Parametersgive request body," + "signature sent in X-Razorpay-Signature header and " + "webhook secret from dashboard as parameters");
  }
