...
/*
 * DOCS://razorpay.com/docs/subscriptions/api/
 */
...
module.exports = function subscriptionsApi(api) {
  ...
  return {
    ...
    fetchfetch(subscriptionId, callback) {
    ...
    updateupdate(subscriptionId, params, callback) {
    ...
    pendingUpdatependingUpdate(subscriptionId, callback) {
    ...
    cancelScheduledChangescancelScheduledChanges(subscriptionId, callback) {
    ...
    deleteOfferdeleteOffer(subscriptionId, offerId, callback) {
    ...
    cancelcancel(subscriptionId) {
      var cancelAtCycleEnd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] ;
      var callback = arguments[2];
      ...
      return api.post(_extends({
        url}, cancelAtCycleEnd && { data: { cancel_at_cycle_end: 1 } }), callback);
    },
    createAddoncreateAddon(subscriptionId, params, callback) {
    ...
    createRegistrationLinkcreateRegistrationLink() {
      var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var callback = arguments[1];
