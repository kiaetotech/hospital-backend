...
/*
 * DOCS://razorpay.com/docs/invoices/
 */
...
module.exports = function invoicesApi(api) {
  ...
  return {
    ...
    delete_delete(invoiceId, callback) {
    ...
    cancelcancel(invoiceId, callback) {
    ...
    notifyBynotifyBy(invoiceId, medium, callback) {
