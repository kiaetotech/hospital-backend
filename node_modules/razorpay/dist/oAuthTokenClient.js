...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value, enumerable, writable, configurable} }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) .__proto__ = superClass; }
...
var OAuthTokenClient = function (_API) {
  ...
  _createClass(OAuthTokenClient, [{
    key: 'getEntityUrl',
    valuegetEntityUrl(params) {
      return params.url;
    }
  }, {
    key: 'generateAuthUrl',
    valuegenerateAuthUrl(params) {
      ...
      var queryString = Object.entries(params).flatMap(function (_ref) {
        ...
        }) === "redirect_uri" ? key + '=' + value + '=' + encodeURIComponent(value);
      }).join("&");
