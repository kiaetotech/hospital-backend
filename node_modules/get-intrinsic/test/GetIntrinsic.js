...
test('dotted paths', function (t) {
	...
	test('underscore paths are aliases for dotted paths', { skip: !Object.isFrozen || Object.isFrozen(Object.prototype) }, function (st) {
		...
		DefinePropertyOrThrow(Object.prototype, 'toString', { '[[Value]]'});
		st.end();
	});
...
test('async generator functions', { skip.length === 0 }, function (t) {
...
test('allowMissing', { skip.length > 0 }, function (t) {
	t['throws'](
