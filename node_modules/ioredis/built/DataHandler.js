...
class DataHandler {
    ...
    returnFatalError(err) {
        ...
        this.redis.recoverFromFatalError(err, err, { offlineQueue});
    }
    returnError(err) {
    ...
    handleSubscriberReply(reply) {
        ...
        const replyType = Array.isArray(reply) ? reply[0].toString() ;
        debug('receive reply "%s" in subscriber mode', replyType);
        switch (replyType) {
            case "message"(this.redis.listeners("message").length > 0) {
            ...
            case "ssubscribe""subscribe""psubscribe": {
            ...
            case "sunsubscribe""unsubscribe""punsubscribe": {
                const channel = reply[1] ? reply[1].toString() ;
                if (channel) {
