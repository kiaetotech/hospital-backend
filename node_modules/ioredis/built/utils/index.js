...
Object.defineProperty(exports, "defaults", { enumerable, get() { return lodash_1.defaults; } });
Object.defineProperty(exports, "isArguments", { enumerable, get() { return lodash_1.isArguments; } });
Object.defineProperty(exports, "noop", { enumerable, get() { return lodash_1.noop; } });
...
function parseURL(url) {
    ...
    // Re-assert string type's type guard (value is string) incorrectly
    ...
    // TODO(next major)rejecting protocol-relative Redis URLs early and
    ...
    if (hasProtocol) {
        ...
        // Prepend a dummy protocol so new URL() can parse "host?query" correctly
        parsed = new URL("redis://" + rawUrl);
    }
    ...
    // Check both username AND password://@host has empty username but valid password.
...
function resolveTLSProfile(options) {
    let tls = options === null || options === void 0 ? void 0 .tls;
    if (typeof tls === "string")
        tls = { profile};
    const profile = TLSProfiles_1.default[tls === null || tls === void 0 ? void 0 .profile];
    if (profile) {
 ...
 *
 * @internal
 * @returns {Promise<{version} | null>} Package metadata or null if unavailable
 */
