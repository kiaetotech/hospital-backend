        ...
        if (this.isCluster) {
            ...
            for (let i = 0; i < this._result.length; ++i) {
                ...
                if (error) {
                    ...
                    const isReadOnly = (0, commands_1.exists)(command.name, { caseInsensitive}) &&
                        (0, commands_1.hasFlag)(command.name, "readonly", { nameCaseInsensitive});
                    if (!isReadOnly) {
                        retriable = false;
                        break;
                    }
...
}, "Pipeline#execBufferPipeline#exec instead");
// NOTEavoid an unhandled promise rejection, this will unconditionally always return this.promise,
