...
class SentinelConnector extends AbstractConnector_1.default {
    ...
    connectToSentinel(endpoint, options) {
        const redis = new Redis_1.default({
            port.port || 26379,
            host.host,
            username.options.sentinelUsername || null,
            password.options.sentinelPassword || null,
            family.family ||
                // @ts-expect-error
                ("path" in this.options && this.options.path
                    ...
                    : // @ts-expect-error
                        this.options.family),
            tls.options.sentinelTLS,
            retryStrategy,
            enableReadyCheck,
            connectTimeout.options.connectTimeout,
            commandTimeout.options.sentinelCommandTimeout,
            ...options,
        });
        // @ts-expect-error
        return redis;
    ...
    async initFailoverDetector() {
        ...
        while (sentinels.length < this.options.sentinelMaxConnections) {
            ...
            const client = this.connectToSentinel(value, {
                lazyConnect,
                retryStrategy.options.sentinelReconnectStrategy,
            });
...
function addressResponseToAddress(input) {
    return { host.ip, port(input.port) };
}
function noop() { }
