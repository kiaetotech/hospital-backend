...
export class PuppeteerNode extends Puppeteer {
    ...
    #getLauncher(browser) {
        ...
        switch (browser) {
            case 'chrome'new ChromeLauncher(this);
            case 'firefox'new FirefoxLauncher(this);
            defaultnew Error(`Unknown product: ${browser}`);
        }
    }
    ...
    async trimCache() {
        ...
        const puppeteerBrowsers = [
            {
                product: 'chrome',
                browser_SupportedBrowser.CHROME,
                currentBuildId: '',
            },
            {
                product: 'firefox',
                browser_SupportedBrowser.FIREFOX,
                currentBuildId: '',
            },
        ];
