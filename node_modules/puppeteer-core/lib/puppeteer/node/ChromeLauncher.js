 ...
 */
import { mkdtemp } from 'node/promises';
import os from 'node';
...
export class ChromeLauncher extends BrowserLauncher {
    ...
    defaultArgs(options = {}) {
        ...
        if (userDataDir) {
            ...
            chromeArguments.push(`--user-data-dir=${path.posix.isAbsolute(userDataDir) || path.win32.isAbsolute(userDataDir) ? userDataDir .resolve(userDataDir)}`);
        }
        if (devtools) {
