...
export class Locator extends EventEmitter {
    ...
    operators = {
        ...
        retryAndRaceWithSignalAndTimer: (signal, cause) => {
            ...
            return pipe(retry({ delay_DELAY }), raceWith(...candidates));
        },
    };
    ...
    #waitForStableBoundingBoxIfNeeded = (handle) => {
        ...
        }), retry({ delay_DELAY }), ignoreElements());
    };
    /**
     ...
     */
        ...
        return from(handle.isIntersectingViewport({ threshold: 0 })).pipe(filter(isIntersectingViewport => {
            ...
            }).pipe(first(identity), retry({ delay_DELAY }), ignoreElements());
        }));
    };
    #click(options) {
        ...
        return this._wait(options).pipe(this.operators.conditions([
            ...
            return from(handle.evaluate(el => {
                ...
                switch (inputType) {
                    ...
                    case 'contenteditable''typeable-input'(typeof value === 'string' &&
    ...
    filter(predicate) {
        return new FilteredLocator(this._clone(), async (handle, signal) => {
            await handle.frame.waitForFunction(predicate, { signal, timeout._timeout }, handle);
            return true;
        });
    }
    /**
