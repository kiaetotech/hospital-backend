...
export class BidiHTTPRequest extends HTTPRequest {
    ...
    #initialize() {
        ...
        this.#request.once('response', data => {
            // Create new response with the initial data. Notedata can be updated later
    ...
    failure() {
        ...
        return { errorText.#request.error };
    }
    isNavigationRequest() {
    ...
    initiator() {
        return {
            ...
            type.#request.initiator?.type ?? 'other',
        };
    }
    redirectChain() {
    ...
    async _continue(overrides = {}) {
        ...
        return await this.#request
            ...
            body.postData
                ? {
                    type: 'base64',
                    valueToBase64(overrides.postData),
                }
                ,
    ...
    async _respond(response, _priority) {
        ...
        if (parsedBody?.contentLength && !hasContentLength) {
            headers.push({
                ...
                value: {
                    type: 'string',
                    value(parsedBody.contentLength),
                },
            });
        }
