...
let Realm = (() => {
    ...
    return class Realm extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _disown_decorators, { kind: "method", name: "disown", static, private, access: { has=> "disown" in obj, get=> obj.disown }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _callFunction_decorators, { kind: "method", name: "callFunction", static, private, access: { has=> "callFunction" in obj, get=> obj.callFunction }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _resolveExecutionContextId_decorators, { kind: "method", name: "resolveExecutionContextId", static, private, access: { has=> "resolveExecutionContextId" in obj, get=> obj.resolveExecutionContextId }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async resolveExecutionContextId() {
            if (!this.executionContextId) {
                const { result } = await this.session.connection.send('goog.resolveRealm', { realm.id });
...
export class WindowRealm extends Realm {
    ...
    get target() {
        return { context.browsingContext.id, sandbox.sandbox };
    }
}
/**
 * @internal
...
export class DedicatedWorkerRealm extends Realm {
    ...
    get session() {
        // SAFETYleast one owner will exist.
