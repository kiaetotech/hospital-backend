...
let UserContext = (() => {
    ...
    return class UserContext extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _dispose_decorators, { kind: "method", name: "dispose", static, private, access: { has=> "dispose" in obj, get=> obj.dispose }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _createBrowsingContext_decorators, { kind: "method", name: "createBrowsingContext", static, private, access: { has=> "createBrowsingContext" in obj, get=> obj.createBrowsingContext }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _remove_decorators, { kind: "method", name: "remove", static, private, access: { has=> "remove" in obj, get=> obj.remove }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _getCookies_decorators, { kind: "method", name: "getCookies", static, private, access: { has=> "getCookies" in obj, get=> obj.getCookies }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _setCookie_decorators, { kind: "method", name: "setCookie", static, private, access: { has=> "setCookie" in obj, get=> obj.setCookie }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _setPermissions_decorators, { kind: "method", name: "setPermissions", static, private, access: { has=> "setPermissions" in obj, get=> obj.setPermissions }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async createBrowsingContext(type, options = {}) {
            const { result: { context}, } = await this.#session.send('browsingContext.create', {
                type,
                ...options,
                referenceContext.referenceContext?.id,
