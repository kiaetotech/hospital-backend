...
let UserPrompt = (() => {
    ...
    return class UserPrompt extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _handle_decorators, { kind: "method", name: "handle", static, private, access: { has=> "handle" in obj, get=> obj.handle }, metadata: _metadata }, null, _instanceExtraInitializers);
