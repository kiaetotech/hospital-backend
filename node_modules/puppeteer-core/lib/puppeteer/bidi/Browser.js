...
let BidiBrowser = (() => {
    ...
    return class BidiBrowser extends _classSuper {
        static {
            ...
            __esDecorate(this, _private_trustedEmitter_descriptor = { get: __setFunctionName(function () { return this.#trustedEmitter_accessor_storage; }, "#trustedEmitter", "get"), set: __setFunctionName(function (value) { this.#trustedEmitter_accessor_storage = value; }, "#trustedEmitter", "set") }, _private_trustedEmitter_decorators, { kind: "accessor", name: "#trustedEmitter", static, private, access: { has=> #trustedEmitter in obj, get=> obj.#trustedEmitter, set: (obj, value) => { obj.#trustedEmitter = value; } }, metadata: _metadata }, _private_trustedEmitter_initializers, _private_trustedEmitter_extraInitializers);
        ...
        static subscribeCdpEvents = [
            // Coverage
            'goog.Debugger.scriptParsed',
            'goog.CSS.styleSheetAdded',
            'goog.Runtime.executionContextsCleared',
            // Tracing
            'goog.Tracing.tracingComplete',
            // TODOto all CDP events in the future.
            'goog.Network.requestWillBeSent',
            'goog.Debugger.scriptParsed',
            'goog.Page.screencastFrame',
        ];
        static async create(opts) {
            const session = await Session.from(opts.connection, {
                ...
                alwaysMatch: {
                    ...
                    'goog',
                    // TODOafter Puppeteer rolled Chrome to 142 after Oct 28, 2025.
                    'goog',
                },
            });
            ...
            await session.subscribe((opts.cdpConnection
                ...
                .subscribeModules).filter(module => {
                if (!opts.networkEnabled) {
                    return (module !== 'network' &&
                        module !== 'goog.Network.requestWillBeSent');
                }
                return true;
            }));
            ...
            async (dataType) => {
                try {
                    await session.send('network.addDataCollector', {
                        dataTypes: [dataType],
                        // Buffer size of 20 MB is equivalent to the CDP: 20_000_000,
                    });
                }
                catch (err) {
        ...
        get connection() {
            // SAFETYonly have one implementation.
