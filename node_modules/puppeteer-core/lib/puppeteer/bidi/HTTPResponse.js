...
let BidiHTTPResponse = (() => {
    ...
    return class BidiHTTPResponse extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _remoteAddress_decorators, { kind: "method", name: "remoteAddress", static, private, access: { has=> "remoteAddress" in obj, get=> obj.remoteAddress }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        constructor(data, request, cdpSupported) {
            ...
            const securityDetails = data['goog'];
        ...
        timing() {
            ...
            return {
                ...
                sendStart.requestStart,
                sendEnd: -1,
                pushStart: -1,
                pushEnd: -1,
                receiveHeadersStart.responseStart,
                receiveHeadersEnd.responseEnd,
            };
        }
        frame() {
