...
let BidiFrame = (() => {
    ...
    return class BidiFrame extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _goto_decorators, { kind: "method", name: "goto", static, private, access: { has=> "goto" in obj, get=> obj.goto }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _setContent_decorators, { kind: "method", name: "setContent", static, private, access: { has=> "setContent" in obj, get=> obj.setContent }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _waitForNavigation_decorators, { kind: "method", name: "waitForNavigation", static, private, access: { has=> "waitForNavigation" in obj, get=> obj.waitForNavigation }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, _private_waitForLoad$_descriptor = { value: __setFunctionName(function (options = {}) {
                    let { waitUntil = 'load' } = options;
                    const { timeout= this.timeoutSettings.navigationTimeout() } = options;
                ...
                }, "#waitForLoad$") }, _private_waitForLoad$_decorators, { kind: "method", name: "#waitForLoad$", static, private, access: { has=> #waitForLoad$ in obj, get=> obj.#waitForLoad$ }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, _private_waitForNetworkIdle$_descriptor = { value: __setFunctionName(function (options = {}) {
                    ...
                    return this.page().waitForNetworkIdle$({
                        idleTime: 500,
                        timeout.timeout ?? this.timeoutSettings.timeout(),
                        concurrency,
                    });
                }, "#waitForNetworkIdle$") }, _private_waitForNetworkIdle$_decorators, { kind: "method", name: "#waitForNetworkIdle$", static, private, access: { has=> #waitForNetworkIdle$ in obj, get=> obj.#waitForNetworkIdle$ }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _setFiles_decorators, { kind: "method", name: "setFiles", static, private, access: { has=> "setFiles" in obj, get=> obj.setFiles }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _locateNodes_decorators, { kind: "method", name: "locateNodes", static, private, access: { has=> "locateNodes" in obj, get=> obj.locateNodes }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        constructor(parent, browsingContext) {
            ...
            this.realms = {
                default.from(this.browsingContext.defaultRealm, this),
                internal.from(this.browsingContext.createWindowRealm(`__puppeteer_internal_${Math.ceil(Math.random() * 10000)}`), this),
            };
        ...
        async goto(url, options = {}) {
            const [response] = await Promise.all([
                ...
                //
                // Related://bugzilla.mozilla.org/show_bug.cgi?id=1846601
                this.browsingContext
                    .navigate(url, "interactive" /* Bidi.BrowsingContext.ReadinessState.Interactive */)
                    .catch(error => {
                    if (isErrorLike(error) &&
                        error.message.includes('net:_HTTP_RESPONSE_CODE_FAILURE')) {
                        return;
                    }
        ...
        async waitForNavigation(options = {}) {
            const { timeout= this.timeoutSettings.navigationTimeout(), signal } = options;
        ...
        async removeExposedFunction(name) {
            ...
            if (!exposedFunction) {
                throw new Error(`Failed to remove page binding with name ${name}['${name}'] does not exists!`);
            }
        ...
        async createCDPSession() {
            ...
            return await cdpConnection._createSession({ targetId._id });
        }
        ...
        async setFiles(element, files) {
            ...
            // SAFETYare always remote references.
