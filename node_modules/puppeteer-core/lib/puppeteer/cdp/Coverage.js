    ...
    async start(options = {}) {
        ...
        await Promise.all([
            ...
            this.#client.send('Profiler.startPreciseCoverage', {
                callCount.#includeRawScriptCoverage,
                detailed,
            }),
            this.#client.send('Debugger.enable'),
            this.#client.send('Debugger.setSkipAllPauses', { skip}),
        ]);
    }
    ...
    async stop() {
        ...
        for (const entry of profileResponse.result) {
            ...
            if (!this.#includeRawScriptCoverage) {
                ...
                coverage.push({ url, ranges, text, rawScriptCoverage});
            }
        }
        return coverage;
    }
...
function convertToDisjointRanges(nestedRanges) {
    ...
    for (const range of nestedRanges) {
        points.push({ offset.startOffset, type: 0, range });
        points.push({ offset.endOffset, type: 1, range });
    }
