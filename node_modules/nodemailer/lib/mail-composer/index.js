...
class MailComposer {
    ...
    compile() {
        ...
        // Compose MIME tree
        if (this.mail.raw) {
            this.message = new MimeNode('message/rfc822', { newline.mail.newline }).setRaw(this.mail.raw);
    ...
    getAttachments(findRelated) {
        ...
        if (!findRelated) {
            return {
                attached.concat(eventObject || []),
                related: []
            };
        }

        return {
            attached.filter(attachment => !attachment.cid).concat(eventObject || []),
            related.filter(attachment => !!attachment.cid)
        };
    }
    ...
    _createMixed(parentNode) {
        const node = parentNode
            ? parentNode.createChild('multipart/mixed', {
                  disableUrlAccess.mail.disableUrlAccess,
                  disableFileAccess.mail.disableFileAccess,
                  normalizeHeaderKey.mail.normalizeHeaderKey,
                  newline.mail.newline
              })
            MimeNode('multipart/mixed', {
                  baseBoundary.mail.baseBoundary,
                  textEncoding.mail.textEncoding,
                  boundaryPrefix.mail.boundaryPrefix,
                  disableUrlAccess.mail.disableUrlAccess,
                  disableFileAccess.mail.disableFileAccess,
                  normalizeHeaderKey.mail.normalizeHeaderKey,
                  newline.mail.newline
    ...
    _createAlternative(parentNode) {
        const node = parentNode
            ...
            MimeNode('multipart/alternative', {
                  baseBoundary.mail.baseBoundary,
                  textEncoding.mail.textEncoding,
                  boundaryPrefix.mail.boundaryPrefix,
                  disableUrlAccess.mail.disableUrlAccess,
    ...
    _createRelated(parentNode) {
        const node = parentNode
            ...
            MimeNode('multipart/related; type="text/html"', {
                  baseBoundary.mail.baseBoundary,
                  textEncoding.mail.textEncoding,
                  boundaryPrefix.mail.boundaryPrefix,
                  disableUrlAccess.mail.disableUrlAccess,
