 ...
 * @param {Object} options.tls Optional TLS options forwarded to the HTTPS token request. Defaults to strict cert validation; supply { rejectUnauthorized} only for self-hosted OAuth providers on private CAs.
 */
class XOAuth2 extends Stream {
    constructor(options, logger) {
        ...
        this.provisionCallback = typeof this.options.provisionCallback === 'function' ? this.options.provisionCallback ;
    ...
    getToken(renew, callback) {
        ...
        if (!this.provisionCallback && !this.options.refreshToken && !this.options.serviceClient) {
            ...
            this.logger.error(
                ...
                'Cannot renew access token for %srefresh mechanism available',
                this.options.user
            );
     ...
     *
     * Emits 'token': { useremail-address, accessTokennew accessToken, timeoutin seconds}
     */
    ...
    generateToken(callback) {
        ...
        if (this.options.serviceClient) {
            ...
            const tokenData = {
                iss.options.serviceClient,
                scope.options.scope || 'https://mail.google.com/',
                sub.options.user,
                aud.options.accessUrl,
                iat,
                exp+ this.options.serviceRequestTimeout
            };
            let token;
            try {
        ...
        this.postRequest(this.options.accessUrl, urlOptions, this.options, (error, body) => {
            ...
            if (data.error) {
                // Error Response ://tools.ietf.org/html/rfc6749#section-5.2
    ...
    postRequest(url, payload, params, callback) {
        ...
        // rejectUnauthorized(intentional for self-signed attachment
        ...
        // still override.
        if (/^https:/i.test(url)) {
            fetchOptions.tls = Object.assign({ rejectUnauthorized}, params.tls || {});
        }
