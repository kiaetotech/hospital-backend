...
class MailMessage {
    ...
    resolveAll(callback) {
        ...
        addressKeys.forEach(address => {
            let value;
            if (this.message) {
                value = [].concat(mimeNode._parseAddresses(this.message.getHeader(address === 'replyTo' ? 'reply-to' )) || []);
    ...
    setPriorityHeaders() {
        ...
        switch ((this.data.priority || '').toString().toLowerCase()) {
            case 'high'.message.setHeader('X-Priority', '1 (Highest)');
                this.message.setHeader('X-MSMail-Priority', 'High');
                this.message.setHeader('Importance', 'High');
                break;
            case 'low'.message.setHeader('X-Priority', '5 (Lowest)');
    ...
    _getListHeaders(listData) {
        // make sure an url looks like <protocol>
