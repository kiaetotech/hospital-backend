 ...
 *  * **localAddress** - outbound address to bind to (see://nodejs.org/api/net.html#net_net_connect_options_connectionlistener)
 ...
 *  * **socket** - existing socket to use instead of creating a new one (see://nodejs.org/api/net.html#net_class_net_socket)
...
class SMTPConnection extends EventEmitter {
    constructor(options) {
        ...
        this.servername = this.options.servername ? this.options.servername : !net.isIP(this.host) ? this.host ;
        ...
        this.logger = shared.getLogger(this.options, {
            component.options.component || 'smtp-connection',
            sid.id
        });
    ...
    connect(connectCallback) {
        ...
        let opts = {
            port.port,
            host.host,
            allowInternalNetworkInterfaces.allowInternalNetworkInterfaces,
            timeout.options.dnsTimeout || DNS_TIMEOUT
        };
    ...
    _connectToHost(opts, secure) {
        ...
        const connectFn = secure ? tls.connect .connect;
        try {
    ...
    login(authData, callback) {
        ...
        if (this.customAuth.has(this._authMethod)) {
            ...
            const handlerResponse = handler({
                ...
                maxAllowedSize._maxAllowedSize || false,
        ...
        switch (this._authMethod) {
            case 'XOAUTH2'._handleXOauth2Token(false, callback);
                return;
            case 'LOGIN'._responseActions.push(str => {
                    this._actionAUTH_LOGIN_USER(str, callback);
                });
                this._sendCommand('AUTH LOGIN');
                return;
            case 'PLAIN'._responseActions.push(str => {
                ...
                return;
            case 'CRAM-MD5'._responseActions.push(str => {
     ...
     * Sends a message
     *
     * @param {Object} envelope Envelope object, {from, to: [addr]}
    ...
    _setEnvelope(envelope, callback) {
        ...
        // RFC 8689the envelope requests REQUIRETLS extension
        // then append REQUIRETLS keyword to the MAIL FROM command
        // Notecan only be used over TLS connections and requires server support
    ...
    /**
     * Handle response for a MAIL FROM*
     * @param {String} str Message from the server
     */
