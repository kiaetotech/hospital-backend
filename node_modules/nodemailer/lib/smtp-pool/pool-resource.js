...
class PoolResource extends EventEmitter {
    constructor(pool) {
        ...
        if (this.options.auth) {
            switch ((this.options.auth.type || '').toString().toUpperCase()) {
                ...
                default(!this.options.auth.user && !this.options.auth.pass) {
                        break;
                    }
                    this.auth = {
    ...
    send(mail, callback) {
        ...
        // RFC 8689requireTLSExtensionEnabled to envelope for MAIL FROM parameter
