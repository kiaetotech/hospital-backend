...
class MimeNode {
    constructor(contentType, options) {
         ...
         */
        this.date = options.parentNode ? null Date();
    ...
    buildHeaders() {
        ...
        this._headers.forEach(header => {
            ...
            switch (header.key) {
                case 'Content-Disposition'= mimeFuncs.parseHeaderValue(value);
                    if (this.filename) {
                ...
                case 'Content-Type'= mimeFuncs.parseHeaderValue(value);
    ...
    createReadStream(options) {
        ...
        for (let i = 0, len = this._transforms.length; i < len; i++) {
            transform = typeof this._transforms[i] === 'function' ? this._transforms[i]() ._transforms[i];
        ...
        if (this.newline) {
            ...
            const newlineTransform = winbreak ? new LeWindows() LeUnix();
            ...
            if (this.content) {
                ...
                const createStream = () => {
                    if (['quoted-printable', 'base64'].includes(transferEncoding)) {
                        contentStream = new (transferEncoding === 'base64' ? base64 ).Encoder(options);
    ...
    _getStream(content) {
        ...
        if (content && typeof content.href === 'string') {
            ...
            // fetch URL
            return nmfetch(content.href, { headers.httpHeaders });
        }
    ...
    _encodeHeaderValue(key, value) {
        ...
        switch (key) {
            // Structured headers
            case 'From''Sender''To''Cc''Bcc''Reply-To'this._convertAddresses(this._parseAddresses(value));

            // values enclosed in <>
            case 'Message-ID''In-Reply-To''Content-Id'= (value || '').toString().replace(/\r?\n|\r/g, ' ');
            ...
            case 'Date'(Object.prototype.toString.call(value) === '[object Date]') {
            ...
            default= (value || '').toString().replace(/\r?\n|\r/g, ' ');
