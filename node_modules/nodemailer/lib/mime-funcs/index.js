...
module.exports = {
     ...
     * PSare following RFC 822 for the list of special characters that we need to keep in quotes.
     *      Refer://www.w3.org/Protocols/rfc1341/4_Content-Type.html
     ...
     * object.
     *
     *   parseHeaderValue('content-type/plain; CHARSET='UTF-8'') ->
     *   {
     *     'value': 'text/plain',
     *     'params': {
     *       'charset': 'UTF-8'
     ...
     */
    detectExtension=> mimeTypes.detectExtension(mimeType),
     ...
     * @return {String} File extension
     */
    detectMimeType=> mimeTypes.detectMimeType(extension),
