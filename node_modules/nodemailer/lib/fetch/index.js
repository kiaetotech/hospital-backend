...
function nmfetch(url, options) {
    ...
    options.maxRedirects = isNaN(options.maxRedirects) ? MAX_REDIRECTS .maxRedirects;
    ...
    const handler = parsed.protocol === 'https:' ? https ;
    ...
    const reqOptions = {
        ...
        host.hostname,
        path.path,
        port.port ? parsed.port .protocol === 'https:' ? 443 : 80,
        headers,
        rejectUnauthorized,
        agent};
    ...
    req.on('response', res => {
        ...
        switch (res.headers['content-encoding']) {
            case 'gzip''deflate'= zlib.createUnzip();
                break;
        }
