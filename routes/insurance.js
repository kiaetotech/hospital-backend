...
/**
 * GET /api/insurance/plans/corporate
 * Get all corporate plans with filters
 */
router.get('/plans/corporate', async (req, res) => {
  try {
    ...
    if (minEmployees) {
      query.minEmployees = { $lte: parseInt(minEmployees) };
    }
    if (maxEmployees) {
      query.maxEmployees = { $gte: parseInt(maxEmployees) };
    }
    if (corporateType) {
      query.corporateType = corporateType;
    }
    if (companyId) {
    ...
    // Get corporate summary for each plan
...
/**
 * GET /api/insurance/plans/corporate/:id
 * Get single corporate plan with employee pricing
 */
router.get('/plans/corporate/:id', async (req, res) => {
  try {
    ...
    // Get employee count ranges for pricing
    const pricingTiers = [];
...
/**
 * POST /api/insurance/plans/corporate/calculate
 * Calculate corporate premium for employee count
 */
...
/**
 * POST /api/insurance/plans/corporate/enroll
 * Enroll a company in corporate plan
 */
...
/**
 * GET /api/insurance/corporate/dashboard
...
/**
 * GET /api/insurance/corporate/employees
 * Get all employees for a corporate plan
 */
...
/**
 * POST /api/insurance/corporate/employees
...
/**
 * PUT /api/insurance/corporate/employees/:id
...
/**
 * DELETE /api/insurance/corporate/employees/:id
...
module.exports = router;h suggestions' });
  }
});
