...
// ============================================
// SEEDCommission Configurations
// ============================================
// Run ONCEseed/commissionConfigs.js
...
const defaultConfigs = [
  ...
  // ============================================
  {
    ...
    effectiveFromDate('2024-01-01'),
    priority: 10,
    platformFee: { enabled, feeType: 'fixed', fixedFee: 30 },
  ...
  // ============================================
  {
    ...
    effectiveFromDate('2024-01-01'),
    priority: 10,
    platformFee: { enabled, feeType: 'fixed', fixedFee: 100 },
    gstConfig: { gstPercentage: 5, hsnCode: '999311' },
  ...
  // ============================================
  {
    ...
    effectiveFromDate('2024-01-01'),
    priority: 10,
    platformFee: { enabled, feeType: 'fixed', fixedFee: 20 },
    gstConfig: { gstPercentage: 18, hsnCode: '999311' },
  ...
  // ============================================
  {
    ...
    effectiveFromDate('2024-01-01'),
    priority: 10,
    platformFee: { enabled, feeType: 'fixed', fixedFee: 50 },
    gstConfig: { gstPercentage: 18 },
    payoutConfig: { payoutFrequency: 'weekly', minimumPayoutAmount: 1000 },
    createdBy: 'system',
    changeReason: 'Initial default configuration'
  ...
  // ============================================
  {
    ...
    effectiveFromDate('2024-01-01'),
    priority: 10,
    platformFee: { enabled, feeType: 'fixed', fixedFee: 0 },
    gstConfig: { gstPercentage: 18 },
